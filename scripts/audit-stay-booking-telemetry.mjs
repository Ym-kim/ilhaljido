...
assert.match(view, /recordStayBookingClick\(\{[\s\S]*?provider:\s*'agoda',\s*mode:\s*'results'/)
assert.match(view, /recordStayBookingClick\(\{[\s\S]*?provider:\s*'booking',\s*mode:\s*'fallback'/)
