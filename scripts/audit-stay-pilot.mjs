...
const checks = [
  ...
  ['Property class and review score are explicitly separated while unrated zero-class values stay hidden', files.view.includes('formatPropertyClass') && files.view.includes("{c.review} {result.reviewScore.toFixed(1)}/10") && files.view.includes('result.starRating > 0') && files.view.includes('{c.propertyClass} {formatPropertyClass(propertyClass, lang)}')],
