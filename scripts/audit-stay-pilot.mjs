...
const checks = [
  ...
  ['Image fallback is visually complete without impersonating a hotel photo', files.view.includes('DESTINATION_VISUALS') && files.view.includes('result.imageUrl ? <span') && files.view.includes('destinationImages[index % destinationImages.length]') && files.view.includes('aspect-[4/3]')],
