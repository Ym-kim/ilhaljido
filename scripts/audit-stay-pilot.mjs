...
const checks = [
  ...
  ['Property class and review score are explicitly separated', files.view.includes('formatPropertyClass') && files.view.includes("{c.review} {result.reviewScore.toFixed(1)}/10") && files.view.includes('{c.propertyClass} {formatPropertyClass(result.starRating, lang)}')],
