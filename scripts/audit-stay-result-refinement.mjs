...
assert.deepEqual(refineStayResults(results, 'property_rating_desc', EMPTY_STAY_RESULT_FILTERS).map((result) => result.propertyId), ['two', 'one', 'three'])
