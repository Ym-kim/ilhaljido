...
const v2Assets = [
  ...
  { id: 'tokyo-model-a-vinyl-dress-v1', file: 'tokyo-model-a-vinyl-dress-v1.webp', width: 1536, height: 1024, modelIds: ['WAK-MODEL-A'] },
...
const optimizedDerivatives = [
  ...
  { file: 'tokyo-model-a-vinyl-dress-v1.avif', width: 1536, height: 1024, maximumBytes: 90_000 },
...
const v2Placements = [
  ...
  { route: 'guide-tokyo', section: 'guide-lookbook-record-dig', models: ['WAK-MODEL-A'], assets: assetIds('tokyo-model-a-vinyl-dress-v1'), source: 'src/lib/guides.ts' },
