...
const v2Assets = [
  ...
  { id: 'domestic-jeju-model-i-coastal-stay-v3', file: 'domestic-jeju-model-i-coastal-stay-v3.webp', width: 1200, height: 900, modelIds: ['WAK-MODEL-I'] },
...
const v2Placements = [
  ...
  { route: 'home', section: 'domestic-jeju', models: ['WAK-MODEL-I'], assets: assetIds('domestic-jeju-model-i-coastal-stay-v3'), source: 'src/components/home/DomesticOnboarding.tsx' },
