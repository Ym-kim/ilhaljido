...
export const SECURITY_GUIDE_COPY: Record<Lang, GuideCopy> = {
  KO: {
    ...
    dataTitle: '데이터 준비와 업무 준비를 함께', dataBody: 'eSIM은 현지 데이터 연결 수단입니다. 기기 호환·테더링·사용량 조건과 계정 보안은 각각 확인하세요.',
  ...
  EN: {
    ...
    dataTitle: 'Plan your connection and your workday', dataBody: 'An eSIM supplies mobile data. Check compatibility, tethering and usage limits separately from account-security settings.',
  ...
  JP: {
    ...
    dataTitle: '通信と仕事環境を一緒に準備', dataBody: 'eSIMは現地でのデータ通信手段です。端末の対応状況・テザリング・利用上限と、アカウントの保護設定は別々に確認しましょう。',
