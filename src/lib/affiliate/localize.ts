...
const EN: Record<string, Overlay> = {
  ...
  'course-midjourney-class': {
    name: 'Inflearn',
    productTitle: 'Midjourney prompt skills for practical AI imagery',
    destination: 'AI · Design',
    desc: 'Learn practical prompt methods for creating content and product-page imagery with Midjourney.',
    cta: 'View course', badge: 'AI design',
  },
  'course-smartstore-keyword': {
    name: 'Inflearn',
    productTitle: 'Smart Store keywords and product SEO',
    destination: 'Selling · Side business',
  ...
  'course-figma-ai': {
    name: 'Inflearn',
    productTitle: 'Supercharge Figma with AI',
    destination: 'Design · UX/UI',
    desc: 'Speed up Figma work with AI — from brief to finished screens.',
    cta: 'View course', badge: 'Design practice',
  },
  'course-data-literacy': {
    name: 'Inflearn',
    productTitle: 'Data literacy — reading and writing with data',
    destination: 'Data · Planning',
    desc: 'Read and judge data without code — for non-engineers who work with numbers.',
    cta: 'View course', badge: 'For non-engineers',
  },
  'course-aws-cloud': {
    name: 'Inflearn',
    productTitle: 'Amazon AWS for beginners',
    destination: 'Development · Infrastructure',
    desc: 'AWS basics from scratch — servers, storage and networking explained simply.',
    cta: 'View course', badge: 'Cloud basics',
  },
  ...
  'course-claude-vibecoding': {
    ...
    destination: 'AI · Vibe coding',
    desc: 'Apply Claude Code and vibe coding to automate workflows and build practical tools.',
    cta: 'View course', badge: 'Practical AI',
  },
  'stay-adina-sydney': {
...
const JP: Record<string, Overlay> = {
  ...
  'course-midjourney-class': {
    name: 'Inflearn',
    productTitle: 'Midjourneyプロンプト実務講座',
    destination: 'AI · デザイン',
    desc: 'コンテンツや商品ページの画像制作に活かせる、Midjourneyの実践的なプロンプト講座。',
    cta: '講座を見る', badge: 'AIデザイン',
  },
  'course-smartstore-keyword': {
    name: 'Inflearn',
    productTitle: 'Smart Storeのキーワード・商品SEO',
    destination: '販売 · 副業',
    desc: '個人オンラインセラー向けに、キーワード選定と商品SEOを学ぶ実務講座。',
    cta: '講座を見る', badge: 'オンライン販売',
  },
  'course-claude-vibecoding': {
    name: 'Inflearn',
    productTitle: 'Claude Code・バイブコーディング実務',
  ...
  'course-figma-ai': {
    name: 'Inflearn',
    productTitle: 'AIでFigmaを加速する',
    destination: 'デザイン · UX/UI',
    desc: 'AIを組み合わせてFigma作業を高速化 — 企画から画面制作まで。',
    cta: '講座を見る', badge: 'デザイン実務',
  },
  'course-data-literacy': {
    name: 'Inflearn',
    productTitle: 'データリテラシー — データを読み書きする技術',
    destination: 'データ · 企画',
    desc: 'コードなしでデータを読み判断する — 数字に振り回されない非エンジニア向け。',
    cta: '講座を見る', badge: '非エンジニア向け',
  },
  'course-aws-cloud': {
    name: 'Inflearn',
    productTitle: 'Amazon AWS 入門',
    destination: '開発 · インフラ',
    desc: 'クラウドが初めてでも進められるAWS基礎 — サーバー・ストレージ・ネットワークの概念から。',
    cta: '講座を見る', badge: 'クラウド入門',
  },
  'act-klook-gardens-singapore': {
