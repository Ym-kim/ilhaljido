...
export const ALL_AFFILIATE_ITEMS: AffiliateItem[] = [
  ...
  // ──────────────────────────────────────────────────────────────────────────
  {
    ...
    badge: '렌터카',
    trackingId: 'Allianceid=9024807',
    coverPhoto: '/covers/carhire-editorial-photo-v2.webp',
    illustrative: true,
  ...
  // ──────────────────────────────────────────────────────────────────────────
  {
    ...
    badge: '공항 라운지',
    trackingId: 'aid=126848',
    coverPhoto: '/covers/airport-lounge-editorial-photo-v2.webp',
    illustrative: true,
  ...
  // ──────────────────────────────────────────────────────────────────────────
  {
    ...
    sourceNote: 'Klook activity/9868-eurail-global-rail-pass (WebSearch KO확정·403=생존 검증 2026-07-18). 가격 ₩477,300~=Klook 검색 리스팅 실브라우저 실측(기준 2026-08-06 — 상세 페이지는 옵션 선택 전 미노출). 유럽 33개국 — 포르투갈 목적지 크로스셀',
  },
