...
export const ALL_AFFILIATE_ITEMS: AffiliateItem[] = [
...

  {
    ...
    badge: '장기체류',
    trackingId: 'aid=7854081',
    coverPhoto: 'https://images.unsplash.com/photo-1540959733332-eab4deabeeaf?auto=format&fit=crop&w=600&q=80',
...

  {
    ...
    badge: '숙소·항공',
    trackingId: 'Allianceid=9024807',
    coverPhoto: 'https://images.unsplash.com/photo-1590559899731-a382839e5549?auto=format&fit=crop&w=600&q=80',
...

  {
    ...
    badge: '장기체류',
    trackingId: 'aid=7854081',
    coverPhoto: 'https://images.unsplash.com/photo-1542051841857-5f90071e7989?auto=format&fit=crop&w=600&q=80',
...

  {
    ...
    badge: '장기체류',
    trackingId: 'aid=7854081',
    coverPhoto: 'https://images.unsplash.com/photo-1537996194471-e657df975ab4?auto=format&fit=crop&w=600&q=80',
...

  {
    ...
    badge: '현지 체험',
    trackingId: '',
    coverPhoto: 'https://images.unsplash.com/photo-1528360983277-13d401cdc186?auto=format&fit=crop&w=600&q=80',
    coverGradient: 'from-red-900 via-rose-950 to-[#0d0d0d]',
    priceFrom: '₩19,000~',
    priority: 5,
    showOn: ['home'],
    sourceNote: 'public URL, tracking not active — KKpartners 일본 카테고리 파트너 링크 수령 후 교체',
    operatorAction: 'KKpartners 대시보드 → 일본 카테고리 딥링크 생성 후 href 교체, status → active_affiliate',
  },

  {
    ...
    badge: 'eSIM',
    trackingId: '',
    coverPhoto: 'https://images.unsplash.com/photo-1516192518150-0d8fee5425e3?auto=format&fit=crop&w=600&q=80',
...

  {
    ...
    cta: '발리 체험 보기',
    href: 'https://www.kkday.com/ko/destination/id-bali',
    badge: '현지 체험',
    trackingId: '',
    coverPhoto: 'https://images.unsplash.com/photo-1518548419970-58e3b4079ab2?auto=format&fit=crop&w=600&q=80',
    coverGradient: 'from-orange-900 via-amber-950 to-[#0d0d0d]',
    priceFrom: '₩25,000~',
    priority: 8,
    showOn: ['home'],
    sourceNote: 'public URL, tracking not active — KKpartners 발리 링크 수령 후 교체',
    operatorAction: 'KKpartners → 발리 카테고리 딥링크 → href 교체, status → active_affiliate',
  },
]
