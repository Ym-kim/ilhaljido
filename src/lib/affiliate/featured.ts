...
export const FEATURED_ESIM: AffiliateItem[] = [
  {
    ...
    badge: '일본 특화',
    trackingId: 'aid=126848',
    coverPhoto: '/covers/esim-japan.svg',
  ...
  },
  {
    ...
    badge: '멀티국',
    trackingId: 'aid=126848',
    coverPhoto: '/covers/esim-asia.svg',
...
export const FEATURED_COURSES: AffiliateItem[] = [
  ...
  // URL은 인프런 검색 인덱스 결과 그대로 사용 (슬러그 조합 금지)
  {
    ...
    badge: 'AI 디자인',
    trackingId: 'partners(utm_campaign=1771445)',
    coverPhoto: '/covers/course-midjourney.svg',
  ...
  },
  {
    ...
    badge: '디자인·웹',
    trackingId: '',
    coverPhoto: '/covers/course-figma.svg',
    coverGradient: 'from-sky-900 via-blue-950 to-[#0d0d0d]',
  ...
  },
  {
    ...
    badge: '스마트스토어',
    trackingId: 'partners(utm_campaign=1771445)',
    coverPhoto: '/covers/course-smartstore.svg',
