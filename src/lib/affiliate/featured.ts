...
export const FEATURED_ACTIVITIES: AffiliateItem[] = [
  ...
  },
  {
    ...
    sourceNote: 'Klook 상품 JSON-LD 실측 (기준 2026-08-06) — 평점 표기는 2026-08-18 액티비티 전량 통일 제거',
  },
  {
  ...
  // 피드 원본 링크의 _currency=USD 파라미터는 표시 통화 강제라 제거(aid·k_site 추적 무변).
  {
    ...
    cta: 'Klook에서 현재 조건 확인', priceFrom: '₩26,600~', priceAsOf: '2026-08-17',
    ...
    sourceNote: 'Klook 파트너 상품 피드 US$ 실측 × 환율 1,415원/USD 환산 — 가격·즉시확정 태그 (기준 2026-08-18)',
  },
  {
    ...
    cta: 'Klook에서 현재 조건 확인', priceFrom: '₩15,900~', priceAsOf: '2026-08-17',
  ...
  },
  {
    ...
    cta: 'Klook에서 현재 조건 확인', priceFrom: '₩25,300~', priceAsOf: '2026-08-17',
  ...
  },
  {
    ...
    cta: 'Klook에서 현재 조건 확인', priceFrom: '₩15,000~', priceAsOf: '2026-08-17',
  ...
  },
  {
    ...
    cta: 'Klook에서 현재 조건 확인', priceFrom: '₩29,800~', priceAsOf: '2026-08-17',
  ...
  },
  {
    ...
    cta: 'Klook에서 현재 조건 확인', priceFrom: '₩13,500~', priceAsOf: '2026-08-17',
  ...
  },
  {
    ...
    cta: 'Klook에서 현재 조건 확인', priceFrom: '₩8,100~', priceAsOf: '2026-08-17',
  ...
  },
  {
    ...
    cta: 'Klook에서 현재 조건 확인', priceFrom: '₩20,100~', priceAsOf: '2026-08-17',
...
export const FEATURED_COURSES: AffiliateItem[] = [
  ...
  {
    // 2026-08-18 신설 — 마케팅·데이터 슬롯 (운영자 링크 생성분 R7cKi)
    id: 'course-ga4-masterclass',
    name: '인프런',
    category: 'education',
    productType: 'education',
    status: 'active_affiliate',
    emoji: '📈',
    productTitle: '구글 애널리틱스 GA4 완전 정복 실무 마스터 클래스',
    destination: '마케팅 · 데이터',
    desc: 'GA4 세팅부터 보고서·실무 분석까지 — 데이터로 성과를 읽는 마케터의 기본기.',
    cta: '강의 보기',
    priceFrom: '₩99,000',
    priceAsOf: '2026-08-18',
    href: 'https://inf.run/R7cKi',
    badge: '데이터 마케팅',
    coverPhoto: '/media/product-editorial/course-analytics-desk-editorial-v1.webp',
    illustrative: true,
    coverGradient: 'from-orange-900 via-amber-950 to-[#0d0d0d]',
    sourceNote: '인프런 강의 페이지 JSON-LD 가격 실측 (기준 2026-08-18) · 파트너 링크 운영자 생성 2026-08-18',
  },
  // ── 2026-09-01 2차 배치 3종 (전부 마소캠퍼스 = 제휴 성공 이력 지식공유자) ──
  // 링크는 운영자가 인프런 파트너스에서 생성, 리다이렉트 목적지·가격 전량 실측 확인함
  {
    id: 'course-figma-ai',
    name: '인프런',
    category: 'education',
    ...
    status: 'active_affiliate',
    emoji: '🎨',
    productTitle: 'AI로 피그마에 날개 달기',
    destination: '디자인 · UX/UI',
    desc: 'AI를 붙여 피그마 작업 속도를 끌어올리는 실무 강의 — 기획안에서 화면까지.',
    cta: '강의 보기',
    priceFrom: '₩79,200',
    priceAsOf: '2026-09-01',
    href: 'https://inf.run/NDhB7',
    badge: '디자인 실무',
    coverPhoto: '/covers/course-figma-ai-photo-v1.webp',
    illustrative: true,
    coverGradient: 'from-violet-900 via-purple-950 to-[#0d0d0d]',
    sourceNote: '인프런 강의 페이지 JSON-LD 가격 실측 (기준 2026-09-01) · 파트너 링크 운영자 생성 2026-09-01',
  },
  {
    ...
    status: 'active_affiliate',
    emoji: '📊',
    productTitle: '데이터 리터러시 — 데이터 읽고 쓰기의 기술',
    destination: '데이터 · 기획',
    desc: '코딩 없이 데이터를 읽고 판단하는 법 — 숫자에 휘둘리지 않는 비개발 직군용.',
    cta: '강의 보기',
    priceFrom: '₩79,200',
    priceAsOf: '2026-09-01',
    href: 'https://inf.run/5pDr3',
    badge: '비개발자용',
    coverPhoto: '/covers/course-data-literacy-photo-v1.webp',
    illustrative: true,
    coverGradient: 'from-teal-900 via-cyan-950 to-[#0d0d0d]',
    sourceNote: '인프런 강의 페이지 JSON-LD 가격 실측 (기준 2026-09-01) · 파트너 링크 운영자 생성 2026-09-01',
  },
  {
    ...
    status: 'active_affiliate',
    emoji: '☁️',
    productTitle: '아마존 AWS 입문',
    destination: '개발 · 인프라',
    desc: '클라우드가 처음이어도 따라가는 AWS 기초 — 서버·스토리지·네트워크 개념부터.',
    cta: '강의 보기',
    priceFrom: '₩49,500',
    priceAsOf: '2026-09-01',
    href: 'https://inf.run/gwgH8',
    badge: '클라우드 입문',
    coverPhoto: '/covers/course-aws-cloud-photo-v1.webp',
    illustrative: true,
    coverGradient: 'from-sky-900 via-blue-950 to-[#0d0d0d]',
    sourceNote: '인프런 강의 페이지 JSON-LD 가격 실측 (기준 2026-09-01) · 파트너 링크 운영자 생성 2026-09-01',
  },
