...
export const FEATURED_COURSES: AffiliateItem[] = [
  ...
  // URL은 인프런 검색 인덱스 결과 그대로 사용 (슬러그 조합 금지)
  {
    ...
    cta: '강의 보기',
    href: 'https://www.inflearn.com/course/%EB%AF%B8%EB%93%9C%EC%A0%80%EB%8B%88-%EB%B9%84%EB%B2%95-%ED%81%B4%EB%9E%98%EC%8A%A4',
    badge: 'AI 디자인',
    trackingId: '',
  ...
  },
  {
    ...
    cta: '강의 보기',
    href: 'https://www.inflearn.com/course/%ED%82%A4%EC%9B%8C%EB%93%9C-%EC%8A%A4%EB%A7%88%ED%8A%B8%EC%8A%A4%ED%86%A0%EC%96%B4',
    badge: '스마트스토어',
    trackingId: '',
