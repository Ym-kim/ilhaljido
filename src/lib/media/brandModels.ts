...
export const BRAND_MODELS: BrandModelProfile[] = [
  ...
  },
  {
    ...
    identityAnchorAssetIds: ['wak-model-e-city-chic-identity-anchor'], referenceAssetIds: ['model-e-source-reference'], productionAssetIds: ['domestic-busan-model-e-coastal-city-v2', 'monthly-2026-08-model-e-city-arrival-v2', 'monthly-model-edit-2026-08-v2'],
    productionUse: 'generated_derivatives_only', sourceType: 'generated_reference', illustrative: true, directPublish: false,
  ...
  },
  {
    ...
    identityAnchorAssetIds: ['wak-model-f-warm-modern-identity-anchor'], referenceAssetIds: ['model-f-source-reference'], productionAssetIds: ['campaign-model-f-japan-choice-desktop-v1', 'campaign-model-f-japan-choice-mobile-v1', 'late-summer-model-f-market-v1', 'home-seasonal-film-2026-08-desktop-v1', 'home-seasonal-film-2026-08-mobile-v1'],
    productionUse: 'generated_derivatives_only', sourceType: 'generated_reference', illustrative: true, directPublish: false,
  ...
  },
  {
    ...
    identityAnchorAssetIds: ['wak-model-g-clean-romantic-identity-anchor'], referenceAssetIds: ['model-g-source-reference'], productionAssetIds: ['domestic-jeju-model-g-slow-stay-v2', 'monthly-2026-08-model-g-coastal-book-cafe-v1'],
    productionUse: 'generated_derivatives_only', sourceType: 'generated_reference', illustrative: true, directPublish: false,
  ...
  },
  {
    ...
    productionAssetIds: ['hosted-models-h-i-coastal-planning-v2', 'hosted-models-h-i-coastal-planning-mobile-v2', 'monthly-2026-08-model-h-coastal-reset-v1', 'monthly-model-edit-2026-08-v2', 'domestic-busan-model-h-haeundae-v3'],
    productionUse: 'generated_derivatives_only', sourceType: 'generated_reference', illustrative: true, directPublish: false,
  ...
  },
  {
    ...
    productionAssetIds: ['hosted-models-h-i-coastal-planning-v2', 'hosted-models-h-i-coastal-planning-mobile-v2', 'select-model-i-travel-prep-v2', 'domestic-jeju-model-i-coastal-stay-v3'],
    productionUse: 'generated_derivatives_only', sourceType: 'generated_reference', illustrative: true, directPublish: false,
  ...
  },
  {
    ...
    identityAnchorAssetIds: ['wak-model-j-city-noir-identity-anchor-v2-2'], referenceAssetIds: ['model-j-source-reference-v2-2'], productionAssetIds: ['domestic-seoul-model-j-city-noir-v2', 'monthly-2026-08-model-j-blue-hour-v2', 'monthly-model-edit-2026-08-v2'],
    productionUse: 'generated_derivatives_only', sourceType: 'generated_reference', illustrative: true, directPublish: false,
  ...
  },
  {
    ...
    productionAssetIds: ['learn-model-k-creative-focus-desktop-v1', 'learn-model-k-creative-focus-mobile-v1', 'programs-model-k-stay-planning-desktop-v1', 'programs-model-k-stay-planning-mobile-v1', 'home-seasonal-film-2026-08-desktop-v1', 'home-seasonal-film-2026-08-mobile-v1'],
    productionUse: 'generated_derivatives_only', sourceType: 'generated_reference', illustrative: true, directPublish: false,
