...
export const BRAND_MODEL_STYLING_RULES: Record<BrandModelId, BrandModelStylingRule> = {
  ...
  'WAK-MODEL-D': { styleDirection: 'fashion-aware exhibition, Tokyo evening and cool winter harbour', summerWardrobe: ['sleeveless fine-knit with pleated midi skirt', 'minimal city dress', 'flat travel sandals'], seasonalFit: ['luminous city summer', 'blue-hour early autumn', 'Southern Hemisphere winter harbour'], activityMood: ['walking through an exhibition', 'choosing an itinerary', 'leaving for the evening', 'lowering a rain-shell hood after rain'], hairVariation: ['soft low ponytail', 'side-parted waves', 'sleek low bun', 'damp wind-moved low ponytail'], realismLevel: 'high_photoreal_editorial', photorealReferenceUsed: true },
...
export const BRAND_MODEL_VISUAL_DIRECTIONS: Record<BrandModelId, ModelVisualDirectionRule> = {
  ...
  'WAK-MODEL-D': { signatureSilhouettes: ['sleeveless shirt dress', 'graphic pleated skirt', 'cropped rain shell and wide winter culottes'], poseFamilies: ['crouched luggage prep', 'turning through an installation', 'two-hand hood lowering'], cameraFamilies: ['low wide departure', 'immersive off-axis', 'elevated diagonal harbour steps'], colorStories: ['tomato, teal and sky blue', 'ultraviolet and silver', 'cobalt, marigold, eucalyptus and oxblood'], avoidRepeating: ['standing itinerary choice', 'taupe lounge scene', 'wet winter harbour steps', 'hood-adjusting pose'] },
...
export const BRAND_MODELS: BrandModelProfile[] = [
  {
    ...
    allowedSections: ['home-hero', 'coastal-editorial', 'slow-stay', 'bali-guide-lookbook'], restrictedSections: COMMON_RESTRICTED_SECTIONS,
    identityAnchorAssetIds: ['wak-model-a-coastal-calm-identity-anchor'], referenceAssetIds: ['model-a-source-reference'],
    productionAssetIds: ['home-hero-model-a-coastal-departure-desktop-v3', 'home-hero-model-a-coastal-departure-mobile-v3', 'home-seasonal-film-2026-08-desktop-v1', 'home-seasonal-film-2026-08-mobile-v1', 'bali-model-a-tropical-cycle-v1'],
  ...
  },
  {
    ...
    wardrobePalette: ['taupe', 'muted blue', 'charcoal', 'deep cobalt', 'marigold', 'eucalyptus', 'oxblood'], preferredActions: ['choosing an itinerary', 'closing a laptop', 'leaving an exhibition', 'lowering a hood after rain'], preferredLocations: ['departure lounge', 'gallery district', 'evening city', 'winter harbour steps'],
    ...
    productionAssetIds: ['trip-match-model-d-itinerary-choice-v3', 'trip-match-model-d-ribbon-choice-v4', 'experience-tokyo-model-d-immersive-gallery-v2', 'sydney-model-d-winter-harbor-v1'],
    productionUse: 'generated_derivatives_only', sourceType: 'generated_reference', illustrative: true, directPublish: false,
    notes: 'Prioritize choice, movement and place rather than a close beauty composition. Preserve the natural seven-to-eight-head editorial balance and do not repeat the Sydney hood-lowering winter-harbour direction on the next major surface.',
  },
  {
  ...
  },
  {
    ...
    allowedSections: ['seoul-editorial', 'city-discovery', 'exhibition-editorial', 'osaka-guide-lookbook'], restrictedSections: COMMON_RESTRICTED_SECTIONS,
    identityAnchorAssetIds: ['wak-model-j-city-noir-identity-anchor-v2-2'], referenceAssetIds: ['model-j-source-reference-v2-2'], productionAssetIds: ['domestic-seoul-model-j-city-noir-v3', 'monthly-2026-08-model-j-blue-hour-v2', 'monthly-model-edit-2026-08-v2', 'osaka-model-j-after-work-gallery-v1'],
    productionUse: 'generated_derivatives_only', sourceType: 'generated_reference', illustrative: true, directPublish: false,
