...
export const BRAND_MODELS: BrandModelProfile[] = [
  ...
  },
  {
    ...
    identityAnchorAssetIds: ['wak-model-g-clean-romantic-identity-anchor'], referenceAssetIds: ['model-g-source-reference'], productionAssetIds: ['domestic-jeju-model-g-slow-stay-v2', 'monthly-2026-08-model-g-coastal-book-cafe-v2', 'jeju-model-g-after-rain-coast-v1'],
    productionUse: 'generated_derivatives_only', sourceType: 'generated_reference', illustrative: true, directPublish: false,
