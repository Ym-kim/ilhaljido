...
export const BRAND_MODELS: BrandModelProfile[] = [
  ...
  },
  {
    ...
    identityAnchorAssetIds: ['wak-model-e-city-chic-identity-anchor'], referenceAssetIds: ['model-e-source-reference'], productionAssetIds: ['domestic-busan-model-e-coastal-city-v2'],
    productionUse: 'generated_derivatives_only', sourceType: 'generated_reference', illustrative: true, directPublish: false,
  ...
  },
  {
    ...
    productionAssetIds: ['hosted-models-h-i-coastal-planning-v2', 'hosted-models-h-i-coastal-planning-mobile-v2'],
    productionUse: 'generated_derivatives_only', sourceType: 'generated_reference', illustrative: true, directPublish: false,
  ...
  },
  {
    ...
    identityAnchorAssetIds: ['wak-model-j-city-noir-identity-anchor-v2-2'], referenceAssetIds: ['model-j-source-reference-v2-2'], productionAssetIds: ['domestic-seoul-model-j-city-noir-v2'],
    productionUse: 'generated_derivatives_only', sourceType: 'generated_reference', illustrative: true, directPublish: false,
