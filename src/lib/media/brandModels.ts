...
export const BRAND_MODELS: BrandModelProfile[] = [
  ...
  },
  {
    ...
    identityAnchorAssetIds: ['wak-model-j-city-noir-identity-anchor-v2-2'], referenceAssetIds: ['model-j-source-reference-v2-2'], productionAssetIds: ['domestic-seoul-model-j-city-noir-v3', 'monthly-2026-08-model-j-blue-hour-v2', 'monthly-model-edit-2026-08-v2'],
    productionUse: 'generated_derivatives_only', sourceType: 'generated_reference', illustrative: true, directPublish: false,
