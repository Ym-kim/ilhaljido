...
export const BRAND_MODELS: BrandModelProfile[] = [
  ...
  },
  {
    ...
    productionAssetIds: ['hosted-models-h-i-coastal-planning-v2', 'hosted-models-h-i-coastal-planning-mobile-v2', 'monthly-2026-08-model-h-coastal-reset-v1', 'monthly-model-edit-2026-08-v2', 'domestic-busan-model-h-haeundae-v3', 'business-models-c-h-k-late-summer-team-desktop-v2', 'business-models-c-h-k-late-summer-team-mobile-v2'],
    productionUse: 'generated_derivatives_only', sourceType: 'generated_reference', illustrative: true, directPublish: false,
