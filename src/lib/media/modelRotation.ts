...
export const EDITORIAL_MODEL_PLACEMENTS: EditorialModelPlacement[] = [
  ...
  { id: 'home-jeju', routes: ['/', '/en', '/ja'], section: 'domestic-onboarding-jeju', modelIds: ['WAK-MODEL-I'], assetIds: ['domestic-jeju-model-i-coastal-stay-v3'], primaryHref: '/destinations/jeju', status: 'active' },
