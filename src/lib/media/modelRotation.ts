...
export const EDITORIAL_MODEL_PLACEMENTS: EditorialModelPlacement[] = [
  ...
  { id: 'programs-hero', routes: ['/programs', '/en/programs', '/ja/programs'], section: 'programs-hero', modelIds: ['WAK-MODEL-H', 'WAK-MODEL-I'], assetIds: ['hosted-models-h-i-coastal-planning-v3', 'hosted-models-h-i-coastal-planning-mobile-v3'], primaryHref: '/hosted', status: 'active' },
  { id: 'growth-hero', routes: ['/growth'], section: 'growth-hero', modelIds: ['WAK-MODEL-B'], assetIds: ['growth-model-b-urban-learning-desktop-v2', 'growth-model-b-urban-learning-mobile-v2'], primaryHref: '/learn', status: 'active' },
  ...
  { id: 'fukuoka-guide-lookbook', routes: ['/guide/fukuoka', '/en/guide/fukuoka', '/ja/guide/fukuoka'], section: 'guide-lookbook-morning-work', modelIds: ['WAK-MODEL-H'], assetIds: ['fukuoka-model-h-cafe-work-v1'], primaryHref: '/collections/fukuoka-3n4d', status: 'active' },
  ...
  { id: 'seoul-guide-lookbook', routes: ['/guide/seoul', '/en/guide/seoul', '/ja/guide/seoul'], section: 'guide-lookbook-after-work-design-lane', modelIds: ['WAK-MODEL-I'], assetIds: ['seoul-model-i-after-work-design-lane-v2'], primaryHref: '/collections/seoul-3n4d', status: 'active' },
  { id: 'busan-guide-lookbook', routes: ['/guide/busan', '/en/guide/busan', '/ja/guide/busan'], section: 'guide-lookbook-after-work-coast', modelIds: ['WAK-MODEL-E'], assetIds: ['busan-model-e-after-work-coast-v1'], primaryHref: '/collections/busan-weekend', status: 'active' },
  { id: 'jeju-guide-lookbook', routes: ['/guide/jeju', '/en/guide/jeju', '/ja/guide/jeju'], section: 'guide-lookbook-after-rain-island-lane', modelIds: ['WAK-MODEL-G'], assetIds: ['jeju-model-g-after-rain-coast-v1'], primaryHref: '/collections/jeju-solo-reset', status: 'active' },
