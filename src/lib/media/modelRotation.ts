...
export const EDITORIAL_MODEL_PLACEMENTS: EditorialModelPlacement[] = [
  ...
  { id: 'tokyo-guide-lookbook', routes: ['/guide/tokyo', '/en/guide/tokyo', '/ja/guide/tokyo'], section: 'guide-lookbook-record-dig', modelIds: ['WAK-MODEL-A'], assetIds: ['tokyo-model-a-vinyl-dress-v1'], primaryHref: '/collections/tokyo-allinone', status: 'active' },
