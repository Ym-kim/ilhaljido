...
export const EDITORIAL_MODEL_PLACEMENTS: EditorialModelPlacement[] = [
  { id: 'home-hero', routes: ['/', '/en', '/ja'], section: 'home-seasonal-hero-2026-08', modelIds: ['WAK-MODEL-A', 'WAK-MODEL-F', 'WAK-MODEL-K'], assetIds: ['home-hero-model-a-coastal-work-desktop-v2', 'home-hero-model-a-coastal-work-mobile-v2', 'late-summer-model-f-market-v1', 'programs-model-k-stay-planning-desktop-v1', 'programs-model-k-stay-planning-mobile-v1', 'home-seasonal-film-2026-08-desktop-v1', 'home-seasonal-film-2026-08-mobile-v1'], primaryHref: '/trip-match', status: 'active' },
  { id: 'home-seoul', routes: ['/', '/en', '/ja'], section: 'domestic-onboarding-seoul', modelIds: ['WAK-MODEL-J'], assetIds: ['domestic-seoul-model-j-city-noir-v3'], primaryHref: '/destinations/seoul', status: 'active' },
  { id: 'home-busan', routes: ['/', '/en', '/ja'], section: 'domestic-onboarding-busan', modelIds: ['WAK-MODEL-H'], assetIds: ['domestic-busan-model-h-haeundae-v4'], primaryHref: '/destinations/busan', status: 'active' },
  { id: 'home-jeju', routes: ['/', '/en', '/ja'], section: 'domestic-onboarding-jeju', modelIds: ['WAK-MODEL-K'], assetIds: ['domestic-jeju-model-k-coastal-stay-v4'], primaryHref: '/destinations/jeju', status: 'active' },
  ...
  { id: 'business-hero', routes: ['/business'], section: 'business-hero', modelIds: ['WAK-MODEL-C', 'WAK-MODEL-H', 'WAK-MODEL-K'], assetIds: ['business-models-c-h-k-late-summer-team-desktop-v2', 'business-models-c-h-k-late-summer-team-mobile-v2'], primaryHref: '#inquiry', status: 'active' },
