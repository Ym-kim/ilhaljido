...
export const EDITORIAL_MODEL_PLACEMENTS: EditorialModelPlacement[] = [
  ...
  { id: 'seoul-guide-lookbook', routes: ['/guide/seoul', '/en/guide/seoul', '/ja/guide/seoul'], section: 'guide-lookbook-after-work-design-lane', modelIds: ['WAK-MODEL-B'], assetIds: ['seoul-model-b-after-work-design-lane-v1'], primaryHref: '/collections/seoul-3n4d', status: 'active' },
