...
export const EDITORIAL_MODEL_PLACEMENTS: EditorialModelPlacement[] = [
  ...
  { id: 'home-busan', routes: ['/', '/en', '/ja'], section: 'domestic-onboarding-busan', modelIds: ['WAK-MODEL-H'], assetIds: ['domestic-busan-model-h-haeundae-v3'], primaryHref: '/destinations/busan', status: 'active' },
