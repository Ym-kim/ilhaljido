...
export const EDITORIAL_MODEL_PLACEMENTS: EditorialModelPlacement[] = [
  ...
  { id: 'sydney-guide-lookbook', routes: ['/guide/sydney', '/en/guide/sydney', '/ja/guide/sydney'], section: 'guide-lookbook-winter-harbour', modelIds: ['WAK-MODEL-D'], assetIds: ['sydney-model-d-winter-harbor-v1'], status: 'active' },
