...
export const MEDIA_ASSETS: MediaAsset[] = [
  ...
  {
    id: 'home-hero-prototype-a-poster-desktop-v1',
    src: '/media/campaigns/home-hero-prototype-a-poster-desktop-v1.webp',
    alt: {
      KO: '바닷가에서 다음 이동을 준비하는 여행자',
      EN: 'A traveler preparing for the next move by the sea',
      JP: '海辺で次の移動を準備する旅行者',
    },
    sourceType: 'generated', usage: 'hero', illustrative: true, mediaType: 'image',
    width: 1600, height: 900, localeUsage: ['ko', 'en', 'ja'], seasonalUsage: ['late-summer'],
    routeUsage: ['/'], sectionUsage: ['home-hero-prototype-a'],
    source: 'Frame derived from a user-provided generated editorial video',
    license: 'User-controlled generated Wakation editorial asset', createdAt: '2026-09-03', verifiedAt: '2026-09-03',
  },
  {
    id: 'home-hero-prototype-a-poster-mobile-v1',
    src: '/media/campaigns/home-hero-prototype-a-poster-mobile-v1.webp',
    alt: {
      KO: '바닷가에서 다음 이동을 준비하는 여행자',
      EN: 'A traveler preparing for the next move by the sea',
      JP: '海辺で次の移動を準備する旅行者',
    ...
    routeUsage: ['/'], sectionUsage: ['home-hero-prototype-a-mobile'],
    source: 'Mobile crop derived from a user-provided generated editorial video',
    license: 'User-controlled generated Wakation editorial asset', createdAt: '2026-09-03', verifiedAt: '2026-09-03',
  },
  {
    id: 'home-hero-prototype-a-desktop-v1',
    src: '/media/campaigns/home-hero-prototype-a-desktop-v1.webm',
    alt: {
      KO: '해안에서 도심 카페로 이어지는 6초 무음 여행 편집 영상',
      EN: 'A six-second silent travel edit moving from the coast to an urban cafe',
      JP: '海辺から都市のカフェへつながる6秒の無音トラベル映像',
    },
    sourceType: 'generated', usage: 'hero', illustrative: true, mediaType: 'video',
    width: 1280, height: 720, localeUsage: ['ko', 'en', 'ja'], seasonalUsage: ['late-summer', 'autumn'],
    routeUsage: ['/'], sectionUsage: ['home-hero-prototype-a'],
    source: 'Two-source desktop prototype edited from user-provided generated videos; close-ups removed',
    license: 'User-controlled generated Wakation editorial asset', createdAt: '2026-09-03', verifiedAt: '2026-09-03',
  },
  {
    id: 'home-hero-prototype-b-desktop-v1',
    src: '/media/campaigns/home-hero-prototype-b-desktop-v1.webm',
    alt: {
      KO: '해안 작업 공간에서 업무를 마치고 바닷가와 도심으로 이어지는 6초 무음 편집 영상',
      EN: 'A six-second silent edit moving from a coastal workspace to the shore and city',
      JP: '海辺のワークスペースから海岸と都市へつながる6秒の無音編集映像',
    },
    sourceType: 'generated', usage: 'hero', illustrative: true, mediaType: 'video',
    width: 1280, height: 720, localeUsage: ['ko', 'en', 'ja'], seasonalUsage: ['late-summer', 'autumn'],
    routeUsage: ['/'], sectionUsage: ['home-hero-prototype-b'],
    source: 'Work-first comparison prototype combining an existing Wakation editorial still with user-provided generated travel videos',
    license: 'User-controlled generated Wakation editorial asset', createdAt: '2026-09-03', verifiedAt: '2026-09-03',
    restriction: {
