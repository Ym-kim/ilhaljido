...
export const MEDIA_ASSETS: MediaAsset[] = [
  ...
  {
    id: 'domestic-jeju-model-i-coastal-stay-v3',
    src: '/media/brand-models/domestic-jeju-model-i-coastal-stay-v3.webp',
    alt: {
      KO: '산방산과 제주 해안을 바라보며 여행 노트를 정리하는 여행자',
      EN: 'A traveler organizing her notes with Sanbangsan and the Jeju coast in view',
      JP: '山房山と済州の海を望みながら旅のノートを整理する旅人',
    },
    sourceType: 'generated', usage: 'editorial', illustrative: true,
    width: 1200, height: 900, modelId: 'WAK-MODEL-I', localeUsage: ['ko', 'en', 'ja'],
    routeUsage: ['/', '/en', '/ja'], sectionUsage: ['domestic-onboarding-jeju'],
    generatedFromReferenceIds: ['destination-jeju-editorial-v1', 'select-model-i-travel-prep-v2'], focalPoint: { x: 0.68, y: 0.48 },
    source: 'OpenAI image generation compositing a licensed Jeju destination reference with an approved Wakation model reference',
    license: 'User-controlled generated Wakation editorial asset; destination reference used under the Unsplash License', createdAt: '2026-08-09', verifiedAt: '2026-08-09',
    restriction: { KO: '실제 참가자나 특정 워케이션 현장 사진이 아니다.', EN: 'Not a photograph of a real participant or Wakation program.', JP: '実在の参加者やワーケーション実施風景の写真ではない。' },
  },
  {
