...
const MODEL_DIVERSITY_ASSETS: MediaAsset[] = [
  ...
  {
    id: 'sydney-model-d-winter-harbor-v1', src: '/media/brand-models/sydney-model-d-winter-harbor-v1.webp',
    alt: { KO: '시드니를 연상시키는 겨울 항구 계단에서 방수 재킷의 후드를 내리는 여행자', EN: 'A traveler lowering her rain-shell hood on winter harbour steps inspired by Sydney', JP: 'シドニーを思わせる冬の港の階段で、防水ジャケットのフードを下ろす旅人' },
    sourceType: 'generated', usage: 'editorial', illustrative: true, mediaType: 'image', width: 1536, height: 1024, modelId: 'WAK-MODEL-D', localeUsage: ['ko', 'en', 'ja'], seasonalUsage: ['winter'], season: 'winter', climateMood: 'cool Southern Hemisphere winter afternoon just after rain', wardrobeFamily: 'cropped rain shell and wide-leg winter culottes', wardrobeTags: ['deep-cobalt rain shell', 'marigold fine knit', 'eucalyptus wide culottes', 'oxblood ankle boots'], hairDirection: 'sleek low ponytail with damp wind-moved strands', activityTags: ['two-hand hood lowering', 'winter harbour transition', 'after-rain walk'], travelContext: 'after-work harbour walk during Sydney winter', styleDirection: 'slightly elevated diagonal winter-harbour environmental editorial', seasonalFit: 'Sydney-inspired August winter after rain', activityMood: 'quietly energized transition from work to waterfront', destinationMood: 'cobalt, marigold, eucalyptus, oxblood and silver-blue harbour light', realismLevel: 'high_photoreal', realismTarget: 'high_photoreal_editorial', realismMethod: 'identity-anchored generation with natural seven-to-eight-head editorial balance, healthy toned silhouette, action-aligned gaze, natural hands, full-body anatomy and crop review', photorealReferenceUsed: true, generationProvider: 'openai_builtin_imagegen', auditDisposition: 'KEEP', adjacentModelRestrictions: ['Do not repeat hood lowering, rain-shell styling, wet sandstone harbour steps or cool silver-blue winter framing on the next major guide surface'], routeUsage: ['/guide/sydney', '/en/guide/sydney', '/ja/guide/sydney'], sectionUsage: ['guide-lookbook-winter-harbour'], generatedFromReferenceIds: ['trip-match-model-d-ribbon-choice-v4'], focalPoint: { x: 0.69, y: 0.5 }, safeFraming: { minHeadroomPercent: 17, preserve: ['head', 'face', 'hands', 'feet'] }, source: 'OpenAI built-in ImageGen using the approved WAK-MODEL-D production reference', license: 'User-controlled generated Wakation editorial asset', createdAt: '2026-08-12', verifiedAt: '2026-08-12', restriction: MODEL_DIVERSITY_RESTRICTION,
  },
]
