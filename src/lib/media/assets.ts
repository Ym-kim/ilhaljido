...
export const MEDIA_ASSETS: MediaAsset[] = [
  ...
  },
  {
    ...
    alt: {
      KO: '해안 업무 공간, 늦여름 골목, 체류 일정을 준비하는 장면을 잇는 7초 무음 편집 영상',
      EN: 'Seven-second silent editorial film moving from coastal work to a late-summer lane and stay planning',
      JP: '海辺のワークシーン、晩夏の街路、滞在計画をつなぐ7秒の無音エディトリアル映像',
    },
    sourceType: 'generated', usage: 'hero', illustrative: true, mediaType: 'video',
    width: 1920, height: 900, modelIds: ['WAK-MODEL-A', 'WAK-MODEL-F', 'WAK-MODEL-K'], localeUsage: ['ko', 'en', 'ja'],
    seasonalUsage: ['late-summer', 'autumn'], routeUsage: ['/', '/en', '/ja'], sectionUsage: ['home-seasonal-hero-2026-08'],
    generatedFromReferenceIds: ['home-hero-model-a-coastal-work-desktop-v2', 'late-summer-model-f-market-v1', 'programs-model-k-stay-planning-desktop-v1'],
  ...
  },
  {
    ...
    alt: {
      KO: '해안 업무 공간, 늦여름 골목, 체류 일정을 준비하는 장면을 잇는 세로형 7초 무음 편집 영상',
      EN: 'Portrait seven-second silent editorial film moving from coastal work to a late-summer lane and stay planning',
      JP: '海辺のワークシーン、晩夏の街路、滞在計画をつなぐ縦型7秒の無音エディトリアル映像',
    },
    sourceType: 'generated', usage: 'hero', illustrative: true, mediaType: 'video',
    width: 1080, height: 1920, modelIds: ['WAK-MODEL-A', 'WAK-MODEL-F', 'WAK-MODEL-K'], localeUsage: ['ko', 'en', 'ja'],
    seasonalUsage: ['late-summer', 'autumn'], routeUsage: ['/', '/en', '/ja'], sectionUsage: ['home-seasonal-hero-2026-08'],
    generatedFromReferenceIds: ['home-hero-model-a-coastal-work-mobile-v2', 'late-summer-model-f-market-v1', 'programs-model-k-stay-planning-mobile-v1'],
