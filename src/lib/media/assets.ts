...
export const MEDIA_ASSETS: MediaAsset[] = [
  ...
  },
  {
    ...
    alt: {
      KO: '디자인 라이브러리에서 여행 노트를 정리하는 성인 여행자의 모바일 편집 이미지',
      EN: 'Mobile editorial view of an adult traveler organizing notes in an unnamed design library',
      JP: 'デザインライブラリーで旅のノートを整理する大人の旅行者のモバイル編集画像',
    },
    sourceType: 'generated', usage: 'hero', illustrative: true,
  ...
  },
  {
    ...
    alt: {
      KO: '해안 작업 공간에서 체류 일정과 여행 가방을 정리하는 성인 여행자의 모바일 편집 이미지',
      EN: 'Mobile editorial view of an adult traveler arranging a stay plan and weekender in a coastal workspace',
      JP: '海辺のワークスペースで滞在予定と旅行バッグを整える大人の旅行者のモバイル編集画像',
    },
    sourceType: 'generated', usage: 'hero', illustrative: true,
    width: 960, height: 1280, modelId: 'WAK-MODEL-K', localeUsage: ['ko', 'en', 'ja'],
  ...
  },
  {
    ...
    alt: {
      KO: '도시 카페에서 지도와 노트를 정리하는 성인 여행자의 모바일 편집 이미지',
      EN: 'Mobile editorial view of an adult traveler organizing a map and notes in a city café',
      JP: '街のカフェで地図とノートを整理する大人の旅行者のモバイル編集画像',
    },
    sourceType: 'generated', usage: 'hero', illustrative: true,
  ...
  },
  {
    ...
    alt: {
      KO: '도시 라운지에서 빈 기획 자료를 검토하는 성인 여행자의 기업 워케이션 편집 이미지',
      EN: 'An adult traveler reviewing a blank planning folio in an unnamed city lounge',
      JP: '街のラウンジで無記名の企画資料を確認する大人の旅行者の編集画像',
    },
    sourceType: 'generated', usage: 'hero', illustrative: true,
  ...
  },
  {
    ...
    alt: {
      KO: '도시 라운지에서 빈 기획 자료를 살펴보는 성인 여행자의 모바일 편집 이미지',
      EN: 'Mobile editorial view of an adult traveler reviewing a blank planning folio in a city lounge',
      JP: '街のラウンジで無記名の企画資料を見る大人の旅行者のモバイル編集画像',
    },
    sourceType: 'generated', usage: 'hero', illustrative: true,
  ...
  },
  {
    ...
    alt: {
      KO: '일본풍 강변 거리에서 지도를 살펴보는 성인 여행자의 모바일 편집 이미지',
      EN: 'Mobile editorial view of an adult traveler checking a map on a Japan-inspired riverside street',
      JP: '日本らしい川沿いの街で地図を見る大人の旅行者のモバイル編集画像',
    },
    sourceType: 'generated', usage: 'hero', illustrative: true,
