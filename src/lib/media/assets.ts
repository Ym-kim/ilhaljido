...
export const MEDIA_ASSETS: MediaAsset[] = [
  ...
  {
    id: 'experience-seoul-model-d-kpop-studio-v1',
    src: '/media/brand-models/experience-seoul-model-d-kpop-studio-v1.webp',
    alt: {
    ...
    sourceType: 'generated', usage: 'editorial', illustrative: true,
    width: 1440, height: 1080, modelId: 'WAK-MODEL-D', localeUsage: ['ko', 'en', 'ja'],
    ...
    generatedFromReferenceIds: ['domestic-seoul-model-d-urban-work-v1'], focalPoint: { x: 0.69, y: 0.5 },
    source: 'OpenAI built-in image generation using the approved WAK-MODEL-D editorial identity reference',
  ...
  {
    id: 'domestic-busan-model-h-haeundae-v3',
    src: '/media/brand-models/domestic-busan-model-h-haeundae-v3.webp',
    alt: {
    ...
    sourceType: 'generated', usage: 'editorial', illustrative: true,
    width: 1200, height: 900, modelId: 'WAK-MODEL-H', localeUsage: ['ko', 'en', 'ja'],
    routeUsage: ['/', '/en', '/ja'], sectionUsage: ['domestic-onboarding-busan'],
    generatedFromReferenceIds: ['destination-busan-editorial-v1', 'monthly-2026-08-model-h-coastal-reset-v1'], focalPoint: { x: 0.31, y: 0.48 },
    source: 'OpenAI image generation compositing a licensed Busan destination reference with an approved Wakation model reference',
  ...
  {
    id: 'growth-model-b-urban-learning-desktop-v1',
    src: '/media/brand-models/growth-model-b-urban-learning-desktop-v1.webp',
    alt: {
    ...
    generatedFromReferenceIds: ['wak-model-b-soft-urban-identity-anchor'], focalPoint: { x: 0.72, y: 0.5 },
    source: 'OpenAI image generation in built-in imagegen mode using the user-provided v2.2 WAK-MODEL-B identity anchor',
    license: 'User-controlled generated brand editorial asset', createdAt: '2026-08-08', verifiedAt: '2026-08-08',
  ...
  {
    id: 'growth-model-b-urban-learning-mobile-v1',
    src: '/media/brand-models/growth-model-b-urban-learning-mobile-v1.webp',
    alt: {
    ...
    sourceType: 'generated', usage: 'hero', illustrative: true,
    width: 960, height: 1280, modelId: 'WAK-MODEL-B', localeUsage: ['ko', 'en', 'ja'],
    routeUsage: ['/growth'], sectionUsage: ['growth-hero-mobile'],
    generatedFromReferenceIds: ['wak-model-b-soft-urban-identity-anchor'], focalPoint: { x: 0.65, y: 0.56 },
    source: 'OpenAI image generation in built-in imagegen mode using the user-provided v2.2 WAK-MODEL-B identity anchor',
    license: 'User-controlled generated brand editorial asset', createdAt: '2026-08-08', verifiedAt: '2026-08-08',
    restriction: { KO: '실제 수강생·캠프 참가자·교육장·운영 프로그램의 현장으로 표현하지 않는다.', EN: 'Do not present as a real learner, camp participant, venue or operating program.', JP: '実在の受講者・キャンプ参加者・会場・運営中プログラムの現場として扱わない。' },
  },
  ...
  },
  {
    ...
    sourceType: 'generated', usage: 'hero', illustrative: true,
    width: 1536, height: 1024, modelId: 'WAK-MODEL-F', localeUsage: ['ko', 'en', 'ja'],
    routeUsage: ['/campaign/japan-short-stay'], sectionUsage: ['campaign-japan-short-stay-hero'],
    generatedFromReferenceIds: ['wak-model-f-warm-modern-identity-anchor'], focalPoint: { x: 0.73, y: 0.52 },
    source: 'OpenAI image generation in built-in imagegen mode using the user-provided v2.2 WAK-MODEL-F identity anchor',
    license: 'User-controlled generated brand editorial asset', createdAt: '2026-08-08', verifiedAt: '2026-08-08',
  ...
  {
    id: 'campaign-model-f-japan-choice-mobile-v1',
    src: '/media/brand-models/campaign-model-f-japan-choice-mobile-v1.webp',
    alt: {
    ...
    sourceType: 'generated', usage: 'hero', illustrative: true,
    width: 960, height: 1280, modelId: 'WAK-MODEL-F', localeUsage: ['ko', 'en', 'ja'],
    routeUsage: ['/campaign/japan-short-stay'], sectionUsage: ['campaign-japan-short-stay-hero-mobile'],
    generatedFromReferenceIds: ['wak-model-f-warm-modern-identity-anchor'], focalPoint: { x: 0.63, y: 0.59 },
    source: 'OpenAI image generation in built-in imagegen mode using the user-provided v2.2 WAK-MODEL-F identity anchor',
    license: 'User-controlled generated brand editorial asset', createdAt: '2026-08-08', verifiedAt: '2026-08-08',
    restriction: { KO: '실제 관광객·고객·가이드·투어·특정 도시나 랜드마크의 현장 사진으로 표현하지 않는다.', EN: 'Do not present as a real tourist, customer, guide, tour, city or landmark photograph.', JP: '実在の旅行者・顧客・ガイド・ツアー・特定都市やランドマークの写真として扱わない。' },
  },
  ...
  },
  {
    ...
    sourceType: 'generated', usage: 'editorial', illustrative: true, mediaType: 'image',
    width: 1200, height: 1500, modelId: 'WAK-MODEL-G', localeUsage: ['ko', 'en', 'ja'],
    routeUsage: ['/about'], sectionUsage: ['monthly-model-editorial-2026-08'],
    generatedFromReferenceIds: ['domestic-jeju-model-g-slow-stay-v2'], focalPoint: { x: 0.62, y: 0.44 },
    source: 'OpenAI built-in image generation using the approved WAK-MODEL-G production reference',
    license: 'User-controlled generated Wakation editorial asset', createdAt: '2026-08-09', verifiedAt: '2026-08-09',
    restriction: {
