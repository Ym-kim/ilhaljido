...
const MODEL_DIVERSITY_ASSETS: MediaAsset[] = [
  {
    id: 'jeonju-model-j-hanok-fan-v1', src: '/media/brand-models/jeonju-model-j-hanok-fan-v1.webp',
    alt: { KO: '한옥 골목의 그늘진 마루에 앉아 부채를 펴는 성인 여행자', EN: 'An adult traveller opening a folding fan on a shaded hanok veranda', JP: '韓屋の路地にある日陰の縁側で扇子を開く大人の旅行者' },
    sourceType: 'generated', usage: 'editorial', illustrative: true, mediaType: 'image', width: 1536, height: 1024, modelId: 'WAK-MODEL-J', localeUsage: ['ko', 'en', 'ja'], seasonalUsage: ['summer', 'late-summer'], season: 'late-summer',
    climateMood: 'humid Jeonju-inspired August morning in cool hanok shade', wardrobeFamily: 'tailored sleeveless wrap midi dress', wardrobeTags: ['persimmon terracotta wrap midi dress', 'cream shoulder bag', 'dark leather sandals'], hairDirection: 'sleek straight hair with subtle humid-air texture', activityTags: ['seated fan opening', 'hanok veranda pause', 'slow morning walk'], travelContext: 'shade-led old-town exploration before the midday heat', styleDirection: 'slightly elevated side-on hanok environmental editorial', seasonalFit: 'humid Korean late-summer morning', activityMood: 'calm tactile pause', destinationMood: 'persimmon, ink tile, honey wood and leaf-green Jeonju-inspired lane', realismLevel: 'high_photoreal', realismTarget: 'high_photoreal_editorial', realismMethod: 'identity-anchored generation with gaze-to-action alignment, realistic fan interaction, natural hands and crop-safe full-body review', photorealReferenceUsed: true, generationProvider: 'openai_builtin_imagegen', auditDisposition: 'KEEP', adjacentModelRestrictions: ['Do not repeat a seated veranda pause, folding fan, persimmon wrap dress or elevated hanok-lane framing on the next major guide surface'], routeUsage: ['/guide/jeonju', '/en/guide/jeonju', '/ja/guide/jeonju'], sectionUsage: ['guide-lookbook-hanok-shade'], generatedFromReferenceIds: ['osaka-model-j-after-work-gallery-v1'], focalPoint: { x: 0.66, y: 0.52 }, safeFraming: { minHeadroomPercent: 16, preserve: ['head', 'face', 'hands', 'bag', 'feet'] }, source: 'OpenAI built-in ImageGen using the approved WAK-MODEL-J production reference', license: 'User-controlled generated Wakation editorial asset', createdAt: '2026-08-12', verifiedAt: '2026-08-12', restriction: MODEL_DIVERSITY_RESTRICTION,
  },
  {
    id: 'yeosu-model-a-harbor-breeze-v1', src: '/media/brand-models/yeosu-model-a-harbor-breeze-v1.webp',
    alt: { KO: '늦여름 항구 산책로에서 바람에 날리는 모자를 붙잡는 성인 여행자', EN: 'An adult traveller catching her hat in the breeze on a late-summer harbour promenade', JP: '晩夏の港の遊歩道で風に飛ばされそうな帽子を押さえる大人の旅行者' },
    sourceType: 'generated', usage: 'editorial', illustrative: true, mediaType: 'image', width: 1536, height: 1024, modelId: 'WAK-MODEL-A', localeUsage: ['ko', 'en', 'ja'], seasonalUsage: ['summer', 'late-summer'], season: 'late-summer',
    climateMood: 'bright breezy Yeosu-inspired late-August harbour afternoon', wardrobeFamily: 'coastal tailored skort set', wardrobeTags: ['coral sleeveless knit', 'deep-cobalt tailored skort', 'striped overshirt tied at waist', 'white sneakers'], hairDirection: 'loose dark hair moving naturally in the sea breeze', activityTags: ['catching straw hat', 'harbour breeze balance', 'after-work waterfront walk'], travelContext: 'late-afternoon coastal reset after a focused work block', styleDirection: 'low wide diagonal harbour-action editorial', seasonalFit: 'hot humid Korean south-coast late summer', activityMood: 'fresh spontaneous coastal movement', destinationMood: 'coral, cobalt, clear sea blue and island green Yeosu-inspired harbour', realismLevel: 'high_photoreal', realismTarget: 'high_photoreal_editorial', realismMethod: 'identity-anchored generation with wind-aligned gaze, grounded feet, natural active hands and crop-safe full-body review', photorealReferenceUsed: true, generationProvider: 'openai_builtin_imagegen', auditDisposition: 'KEEP', adjacentModelRestrictions: ['Do not repeat a hat-catching action, coral knit, cobalt skort or low diagonal harbour framing on the next major guide surface'], routeUsage: ['/guide/yeosu', '/en/guide/yeosu', '/ja/guide/yeosu'], sectionUsage: ['guide-lookbook-harbour-breeze'], generatedFromReferenceIds: ['home-hero-model-a-coastal-departure-desktop-v3'], focalPoint: { x: 0.34, y: 0.54 }, safeFraming: { minHeadroomPercent: 18, preserve: ['head', 'face', 'hands', 'bag', 'feet'] }, source: 'OpenAI built-in ImageGen using the approved WAK-MODEL-A production reference', license: 'User-controlled generated Wakation editorial asset', createdAt: '2026-08-12', verifiedAt: '2026-08-12', restriction: MODEL_DIVERSITY_RESTRICTION,
  },
  {
  ...
  {
    id: 'tokyo-model-b-record-shop-v2', src: '/media/brand-models/tokyo-model-b-record-shop-v2.webp',
    alt: { KO: '밝은 도쿄풍 레코드숍에서 음반 커버를 두 손으로 살펴보는 여행자', EN: 'A traveler examining a record sleeve in a bright Tokyo-inspired record shop', JP: '明るい東京風のレコードショップで、ジャケットを両手で確かめる旅人' },
    sourceType: 'generated', usage: 'editorial', illustrative: true, mediaType: 'image', width: 1536, height: 1024, modelId: 'WAK-MODEL-B', localeUsage: ['ko', 'en', 'ja'], seasonalUsage: ['summer', 'late-summer'], season: 'late-summer', climateMood: 'fresh late-summer daylight with cool gallery lighting', wardrobeFamily: 'graphic A-line midi skirt', wardrobeTags: ['teal sleeveless knit', 'cream graphic midi skirt', 'mustard shoulder bag', 'ivory sneakers'], hairDirection: 'loose natural waves with soft flyaways', activityTags: ['record browsing', 'two-hand sleeve inspection', 'after-work discovery'], travelContext: 'independent urban culture after work', styleDirection: 'eye-level daylight record-shop editorial', seasonalFit: 'bright late-summer Tokyo afternoon', activityMood: 'focused and natural cultural discovery', destinationMood: 'mint, vermilion and saffron Tokyo-inspired record shop', realismLevel: 'high_photoreal', realismTarget: 'high_photoreal_editorial', realismMethod: 'identity-anchored generation with gaze-to-action alignment, natural hands, full-body anatomy and crop review', photorealReferenceUsed: true, generationProvider: 'openai_builtin_imagegen', auditDisposition: 'KEEP', adjacentModelRestrictions: ['Do not repeat record browsing, a graphic A-line skirt, eye-level shop framing or a mint-vermilion interior on the next major guide surface'], routeUsage: ['/guide/tokyo', '/en/guide/tokyo', '/ja/guide/tokyo'], sectionUsage: ['guide-lookbook-record-dig'], generatedFromReferenceIds: ['growth-model-b-urban-learning-desktop-v2'], focalPoint: { x: 0.58, y: 0.52 }, safeFraming: { minHeadroomPercent: 15, preserve: ['head', 'face', 'hands', 'bag', 'feet'] }, source: 'OpenAI built-in ImageGen using the approved WAK-MODEL-B production reference', license: 'User-controlled generated Wakation editorial asset', createdAt: '2026-08-11', verifiedAt: '2026-08-11', restriction: MODEL_DIVERSITY_RESTRICTION,
  },
  {
    id: 'danang-model-c-tropical-market-v1', src: '/media/brand-models/danang-model-c-tropical-market-v1.webp',
    alt: { KO: '다낭을 연상시키는 열대 시장에서 용과를 살펴보는 여행자', EN: 'A traveler examining dragon fruit in a Da Nang-inspired tropical market', JP: 'ダナンを思わせるトロピカルマーケットでドラゴンフルーツを見る旅人' },
    sourceType: 'generated', usage: 'editorial', illustrative: true, mediaType: 'image', width: 1536, height: 1024, modelId: 'WAK-MODEL-C', localeUsage: ['ko', 'en', 'ja'], seasonalUsage: ['summer', 'late-summer'], season: 'late-summer', climateMood: 'humid tropical late-afternoon daylight', wardrobeFamily: 'shaped cotton midi dress', wardrobeTags: ['coral square-neck midi dress', 'turquoise woven belt', 'cream crossbody bag', 'woven sandals'], hairDirection: 'loose low ponytail with natural flyaways', activityTags: ['fruit browsing', 'two-hand market selection', 'after-work local discovery'], travelContext: 'local market discovery after a focused work morning', styleDirection: 'eye-level tropical market environmental editorial', seasonalFit: 'humid Da Nang late summer', activityMood: 'curious colorful local discovery', destinationMood: 'coral, jade and tropical-fruit Da Nang-inspired market', realismLevel: 'high_photoreal', realismTarget: 'high_photoreal_editorial', realismMethod: 'identity-anchored generation with gaze-to-action alignment, natural hands, full-body anatomy and crop review', photorealReferenceUsed: true, generationProvider: 'openai_builtin_imagegen', auditDisposition: 'KEEP', adjacentModelRestrictions: ['Do not repeat fruit browsing, a coral shaped dress, an eye-level market aisle or jade-and-coral materials on the next major guide surface'], routeUsage: ['/guide/danang', '/en/guide/danang', '/ja/guide/danang'], sectionUsage: ['guide-lookbook-tropical-market'], generatedFromReferenceIds: ['domestic-busan-model-c-coastal-transition-v1'], focalPoint: { x: 0.42, y: 0.54 }, safeFraming: { minHeadroomPercent: 16, preserve: ['head', 'face', 'hands', 'bag', 'feet'] }, source: 'OpenAI built-in ImageGen using the approved WAK-MODEL-C production reference', license: 'User-controlled generated Wakation editorial asset', createdAt: '2026-08-11', verifiedAt: '2026-08-11', restriction: MODEL_DIVERSITY_RESTRICTION,
  },
  {
    id: 'bali-model-a-tropical-cycle-v1', src: '/media/brand-models/bali-model-a-tropical-cycle-v1.webp',
    alt: { KO: '발리를 연상시키는 열대의 초록길에서 자전거를 끌고 걷는 여행자', EN: 'A traveler walking a bicycle along a Bali-inspired tropical green lane', JP: 'バリを思わせる緑の道で自転車を押して歩く旅人' },
    sourceType: 'generated', usage: 'editorial', illustrative: true, mediaType: 'image', width: 1536, height: 1024, modelId: 'WAK-MODEL-A', localeUsage: ['ko', 'en', 'ja'], seasonalUsage: ['summer', 'late-summer'], season: 'late-summer', climateMood: 'warm tropical after-shower late-afternoon light', wardrobeFamily: 'asymmetrical wrap midi dress', wardrobeTags: ['hibiscus-magenta wrap midi dress', 'woven crossbody bag', 'flat leather sandals'], hairDirection: 'wind-moved low braid with natural flyaways', activityTags: ['walking bicycle', 'guiding handlebars', 'after-work tropical ride'], travelContext: 'slow after-work neighborhood exploration', styleDirection: 'slightly elevated three-quarter curved-lane environmental editorial', seasonalFit: 'Bali dry-season late afternoon after a passing shower', activityMood: 'unhurried active local discovery', destinationMood: 'hibiscus, banana-green and wet-stone Bali-inspired rural lane', realismLevel: 'high_photoreal', realismTarget: 'high_photoreal_editorial', realismMethod: 'identity-anchored generation with naturally luminous skin, realistic silhouette dimension, action-aligned gaze, natural hands, full-body anatomy and crop review', photorealReferenceUsed: true, generationProvider: 'openai_builtin_imagegen', auditDisposition: 'KEEP', adjacentModelRestrictions: ['Do not repeat bicycle walking, a magenta wrap dress, a wet rice-field lane or elevated curved-road framing on the next major guide surface'], routeUsage: ['/guide/bali', '/en/guide/bali', '/ja/guide/bali'], sectionUsage: ['guide-lookbook-tropical-cycle'], generatedFromReferenceIds: ['home-hero-model-a-coastal-departure-desktop-v3'], focalPoint: { x: 0.47, y: 0.55 }, safeFraming: { minHeadroomPercent: 18, preserve: ['head', 'face', 'hands', 'bag', 'feet'] }, source: 'OpenAI built-in ImageGen using the approved WAK-MODEL-A production reference, followed by a framing-only edit', license: 'User-controlled generated Wakation editorial asset', createdAt: '2026-08-11', verifiedAt: '2026-08-11', restriction: MODEL_DIVERSITY_RESTRICTION,
  },
  {
    id: 'chiangmai-model-e-red-ride-v1', src: '/media/brand-models/chiangmai-model-e-red-ride-v1.webp',
    alt: { KO: '치앙마이를 연상시키는 나무 그늘의 거리에서 빨간 이동수단에서 내리는 여행자', EN: 'A traveler stepping down from a red shared ride on a leafy Chiang Mai-inspired street', JP: 'チェンマイを思わせる木陰の通りで、赤い乗り合い車から降りる旅人' },
    sourceType: 'generated', usage: 'editorial', illustrative: true, mediaType: 'image', width: 1536, height: 1024, modelId: 'WAK-MODEL-E', localeUsage: ['ko', 'en', 'ja'], seasonalUsage: ['summer', 'late-summer'], season: 'late-summer', climateMood: 'warm dry-season late-afternoon shade', wardrobeFamily: 'tailored summer skort set', wardrobeTags: ['ivory structured sleeveless blouse', 'deep-jade tailored skort', 'coral woven crossbody bag', 'tan walking sandals'], hairDirection: 'relaxed high ponytail with natural flyaways', activityTags: ['shared-ride step-down', 'one-hand rail grip', 'after-work city transfer'], travelContext: 'short after-work ride between Nimman and the Old City', styleDirection: 'low three-quarter transit-side environmental editorial', seasonalFit: 'warm Chiang Mai dry-season afternoon', activityMood: 'confident playful city arrival', destinationMood: 'vermilion, jade, turquoise and saffron Chiang Mai-inspired leafy street', realismLevel: 'high_photoreal', realismTarget: 'high_photoreal_editorial', realismMethod: 'identity-anchored generation with natural seven-to-eight-head editorial balance, healthy toned silhouette, action-aligned gaze, natural hands, full-body anatomy and crop review', photorealReferenceUsed: true, generationProvider: 'openai_builtin_imagegen', auditDisposition: 'KEEP', adjacentModelRestrictions: ['Do not repeat a red shared vehicle, transport step-down action, deep-jade skort or low transit-side framing on the next major guide surface'], routeUsage: ['/guide/chiangmai', '/en/guide/chiangmai', '/ja/guide/chiangmai'], sectionUsage: ['guide-lookbook-red-ride'], generatedFromReferenceIds: ['busan-model-e-harbor-steps-skirt-v2'], focalPoint: { x: 0.39, y: 0.55 }, safeFraming: { minHeadroomPercent: 17, preserve: ['head', 'face', 'hands', 'bag', 'feet'] }, source: 'OpenAI built-in ImageGen using the approved WAK-MODEL-E production reference', license: 'User-controlled generated Wakation editorial asset', createdAt: '2026-08-11', verifiedAt: '2026-08-11', restriction: MODEL_DIVERSITY_RESTRICTION,
  },
  {
  ...
  {
    id: 'cebu-model-f-island-prep-v1', src: '/media/brand-models/cebu-model-f-island-prep-v1.webp',
    alt: { KO: '세부를 연상시키는 열대 항구에서 파란 방수 가방을 여미는 여행자', EN: 'A traveler fastening a blue dry bag at a Cebu-inspired tropical harbor', JP: 'セブを思わせるトロピカルな港で青いドライバッグを閉じる旅人' },
    sourceType: 'generated', usage: 'editorial', illustrative: true, mediaType: 'image', width: 1536, height: 1024, modelId: 'WAK-MODEL-F', localeUsage: ['ko', 'en', 'ja'], seasonalUsage: ['summer', 'late-summer'], season: 'late-summer', climateMood: 'bright tropical dry-season late afternoon', wardrobeFamily: 'sunlit A-line midi skirt', wardrobeTags: ['ivory sleeveless camp-collar top', 'mango-yellow A-line midi skirt', 'coral flat sandals'], hairDirection: 'loose low braid with natural wind-moved strands', activityTags: ['dry-bag fastening', 'island afternoon preparation', 'harbor step'], travelContext: 'light preparation for a waterside afternoon after work', styleDirection: 'waist-height off-axis tropical harbor environmental editorial', seasonalFit: 'hot humid Cebu-inspired dry-season afternoon', activityMood: 'focused, warm and practical island preparation', destinationMood: 'mango, cobalt, coral, turquoise and sunlit white', realismLevel: 'high_photoreal', realismTarget: 'high_photoreal_editorial', realismMethod: 'identity-anchored generation with natural seven-to-eight-head editorial balance, healthy toned silhouette, action-aligned gaze, natural hands, full-body anatomy and crop review', photorealReferenceUsed: true, generationProvider: 'openai_builtin_imagegen', auditDisposition: 'KEEP', adjacentModelRestrictions: ['Do not repeat dry-bag fastening, a mango A-line skirt, a tropical harbor step or waist-height island-harbor framing on the next major guide surface'], routeUsage: ['/guide/cebu', '/en/guide/cebu', '/ja/guide/cebu'], sectionUsage: ['guide-lookbook-island-prep'], generatedFromReferenceIds: ['campaign-model-f-japan-choice-desktop-v2'], focalPoint: { x: 0.69, y: 0.5 }, safeFraming: { minHeadroomPercent: 15, preserve: ['head', 'face', 'hands', 'bag', 'feet'] }, source: 'OpenAI built-in ImageGen using the approved WAK-MODEL-F production reference', license: 'User-controlled generated Wakation editorial asset', createdAt: '2026-08-11', verifiedAt: '2026-08-11', restriction: MODEL_DIVERSITY_RESTRICTION,
  },
  {
    id: 'sydney-model-d-clear-winter-skirt-v2', src: '/media/brand-models/sydney-model-d-clear-winter-skirt-v2.webp',
    alt: { KO: '시드니를 연상시키는 맑은 겨울 항구 계단을 미니스커트와 가벼운 재킷 차림으로 내려오는 여행자', EN: 'A traveler in a tailored mini skirt carrying a light jacket down clear winter harbour steps inspired by Sydney', JP: 'シドニーを思わせる晴れた冬の港の階段を、ミニスカートと薄手のジャケット姿で下りる旅人' },
    sourceType: 'generated', usage: 'editorial', illustrative: true, mediaType: 'image', width: 1536, height: 1024, modelId: 'WAK-MODEL-D', localeUsage: ['ko', 'en', 'ja'], seasonalUsage: ['winter'], season: 'winter', climateMood: 'clear mild Southern Hemisphere winter midday', wardrobeFamily: 'fitted knit and tailored winter mini skirt', wardrobeTags: ['ivory fitted short-sleeve rib knit', 'deep-cobalt tailored A-line mini skirt', 'sheer charcoal tights', 'saffron lightweight jacket', 'oxblood knee-high boots'], hairDirection: 'wind-moved straight hair with a clean side part', activityTags: ['diagonal stair descent', 'light-jacket carry', 'clear-day harbour walk'], travelContext: 'after-work harbour walk during a clear Sydney winter midday', styleDirection: 'slightly low three-quarter clear-harbour environmental editorial', seasonalFit: 'Sydney-inspired clear August winter noon around a mild daytime high', activityMood: 'confident, feminine and purposeful waterfront transition', destinationMood: 'clear blue, sandstone, deep cobalt, saffron and oxblood', realismLevel: 'high_photoreal', realismTarget: 'high_photoreal_editorial', realismMethod: 'identity-anchored generation with natural seven-to-eight-head editorial balance, realistic healthy anatomy, tasteful waist-defined styling, action-aligned gaze, natural hands, full-body anatomy and crop review', photorealReferenceUsed: true, generationProvider: 'openai_builtin_imagegen', auditDisposition: 'KEEP', adjacentModelRestrictions: ['Do not repeat stair descent, a fitted ivory knit with cobalt mini skirt, knee-high boots or bright sandstone harbour framing on the next major guide surface'], routeUsage: ['/guide/sydney', '/en/guide/sydney', '/ja/guide/sydney'], sectionUsage: ['guide-lookbook-clear-winter-harbour'], generatedFromReferenceIds: ['trip-match-model-d-ribbon-choice-v4'], focalPoint: { x: 0.69, y: 0.49 }, safeFraming: { minHeadroomPercent: 16, preserve: ['head', 'face', 'hands', 'bag', 'feet'] }, source: 'OpenAI built-in ImageGen using the approved WAK-MODEL-D production reference', license: 'User-controlled generated Wakation editorial asset', createdAt: '2026-08-12', verifiedAt: '2026-08-12', restriction: MODEL_DIVERSITY_RESTRICTION,
  },
]
...
export const MEDIA_ASSETS: MediaAsset[] = [
  ...
  {
    id: 'busan-model-e-after-work-coast-v1',
    src: '/media/brand-models/busan-model-e-after-work-coast-v1.webp',
    alt: {
      KO: '늦여름 해안 도시 산책로를 노트북 슬리브와 가벼운 가방을 들고 걷는 성인 여행자',
      EN: 'An adult traveller walking a late-summer coastal-city promenade with a laptop sleeve and light bag',
      JP: '晩夏の海辺の街をノートPCケースと軽いバッグで歩く大人の旅行者',
    },
    sourceType: 'generated', usage: 'editorial', illustrative: true, mediaType: 'image',
    width: 1536, height: 1024, modelId: 'WAK-MODEL-E', localeUsage: ['ko', 'en', 'ja'],
    seasonalUsage: ['summer', 'late-summer'], season: 'late-summer',
    climateMood: 'clear coastal daylight after a short summer shower',
    wardrobeFamily: 'breathable refined coastal travel',
    wardrobeTags: ['muted-coral sleeveless linen shell', 'sand wide-leg linen trousers', 'flat leather sandals'],
    hairDirection: 'natural long dark hair with light sea-breeze movement',
    activityTags: ['after-work coastal walk', 'carrying laptop sleeve', 'moving between city and sea'],
    travelContext: 'Busan guide lookbook; generic coastal-city editorial scene',
    styleDirection: 'high-photoreal travel editorial with full-body environmental framing',
    seasonalFit: 'late-summer coastal workation',
    activityMood: 'fresh transition from focused work to the waterfront',
    destinationMood: 'Busan-inspired city-and-sea rhythm without a real venue claim',
    ...
    photorealReferenceUsed: true, generationProvider: 'openai_builtin_imagegen', auditDisposition: 'KEEP',
    routeUsage: ['/guide/busan', '/en/guide/busan', '/ja/guide/busan'],
    sectionUsage: ['guide-lookbook-after-work-coast'],
    generatedFromReferenceIds: ['monthly-2026-08-model-e-city-arrival-v2', 'domestic-busan-model-e-coastal-city-v2'],
    focalPoint: { x: 0.39, y: 0.5 },
    safeFraming: { minHeadroomPercent: 10, preserve: ['head', 'face', 'hands', 'bag', 'device', 'feet'] },
    source: 'OpenAI built-in ImageGen using approved WAK-MODEL-E production references',
  ...
  {
    id: 'seoul-model-i-after-work-design-lane-v2',
    src: '/media/brand-models/seoul-model-i-after-work-design-lane-v2.webp',
    alt: {
      KO: '늦여름 비가 그친 디자인 골목을 가벼운 옷차림으로 걷는 성인 여행자',
      EN: 'An adult traveler in lightweight summer clothing walking through a design lane after rain',
      JP: '晩夏の雨上がり、涼やかな装いでデザイン街を歩く成人旅行者',
    },
    sourceType: 'generated', usage: 'editorial', illustrative: true, mediaType: 'image',
    width: 1536, height: 1024, modelId: 'WAK-MODEL-I', localeUsage: ['ko', 'en', 'ja'],
    seasonalUsage: ['late-summer'], season: 'late-summer',
    climateMood: 'fresh humid Seoul-inspired afternoon after late-summer rain',
    wardrobeFamily: 'cool breathable refined summer casual',
    wardrobeTags: ['ice-blue sleeveless linen shell', 'ivory lightweight wide-leg trousers', 'flat leather sandals'],
    hairDirection: 'long chestnut soft waves with full head preserved',
    ...
    realismLevel: 'high_photoreal', realismTarget: 'high_photoreal_editorial',
    realismMethod: 'Identity-preserve generation from an approved WAK-MODEL-I production derivative with explicit natural-skin and fabric-texture direction',
    photorealReferenceUsed: true, generationProvider: 'openai_builtin_imagegen', auditDisposition: 'KEEP',
    routeUsage: ['/guide/seoul', '/en/guide/seoul', '/ja/guide/seoul'],
    sectionUsage: ['guide-lookbook-after-work-design-lane'],
    generatedFromReferenceIds: ['select-model-i-travel-prep-v3'],
    focalPoint: { x: 0.74, y: 0.5 },
    safeFraming: { minHeadroomPercent: 12, preserve: ['head', 'face', 'hands', 'device', 'bag', 'feet'] },
    source: 'OpenAI built-in ImageGen using the approved WAK-MODEL-I travel-prep production asset as identity reference',
    license: 'User-controlled generated brand editorial asset',
  ...
  {
    id: 'busan-gwangalli-night-licensed-v1',
    src: '/media/destinations/busan-gwangalli-night-licensed-v1.webp',
    alt: {
      KO: '광안리 해변에서 바라본 광안대교와 부산의 야경',
      EN: 'Gwangan Bridge and the Busan night skyline seen from Gwangalli Beach',
      JP: '広安里ビーチから望む広安大橋と釜山の夜景',
    },
    ...
    climateMood: 'clear October night at Gwangalli Beach',
    activityTags: ['waterfront walk', 'night view', 'after-work reset'],
    travelContext: 'Busan guide lookbook; real Gwangalli Beach destination photograph',
    ...
    routeUsage: ['/guide/busan', '/en/guide/busan', '/ja/guide/busan'],
    sectionUsage: ['guide-lookbook-night-gwangalli'], focalPoint: { x: 0.54, y: 0.42 },
    source: 'https://commons.wikimedia.org/wiki/File:Gwangalli_Beach_Busan_(31877282438).jpg',
    license: 'CC BY-SA 2.0; photo by bryan... (Flickr user 91049143@N00); cropped and color-adjusted by Wakation',
    createdAt: '2018-10-14', verifiedAt: '2026-08-11',
    restriction: {
      KO: '저작자 표시와 CC BY-SA 2.0 조건을 유지하며, 원 저작자가 Wakation을 후원한다고 표현하지 않는다.',
      EN: 'Keep creator credit and CC BY-SA 2.0 terms; do not imply the creator endorses Wakation.',
      JP: '作者表示とCC BY-SA 2.0の条件を維持し、作者がWakationを推薦しているように表現しない。',
    },
  },
  {
  ...
  {
    id: 'china-market-research-urban-editorial-v1',
    src: '/media/campaigns/china-market-research-urban-editorial-v1.webp',
    alt: {
      KO: '도심 카페 앞에서 휴대폰으로 일정을 확인하는 여행자',
      EN: 'A traveler checking an itinerary on a phone outside an urban cafe',
      JP: '都市のカフェ前でスマートフォンの日程を確認する旅行者',
    },
    sourceType: 'generated', usage: 'editorial', illustrative: true, mediaType: 'image',
    width: 1280, height: 960, localeUsage: ['ko', 'en', 'ja'], seasonalUsage: ['autumn'],
    routeUsage: ['/programs/china-market-research'], sectionUsage: ['home-china-market-research'],
    source: 'Frame derived from a user-provided generated editorial video',
    license: 'User-controlled generated Wakation editorial asset', createdAt: '2026-09-03', verifiedAt: '2026-09-03',
    restriction: {
      KO: '실제 중국 도시, 시장조사단 참가자 또는 프로그램 현장으로 표시하지 않습니다.',
      EN: 'Do not present as a real Chinese city, program participant or program venue.',
      JP: '実在の中国都市、市場調査団参加者、プログラム会場として表示しません。',
    },
  },
  {
    id: 'home-hero-story-poster-desktop-v2',
    src: '/media/campaigns/home-hero-story-poster-desktop-v2.webp',
    alt: {
      KO: '도심에서 여행 자료와 가방을 챙겨 이동하는 여행자',
      EN: 'A traveler leaving the city with a travel note and bag',
      JP: '街で旅の資料とバッグを手に移動する旅行者',
    },
    sourceType: 'generated', usage: 'hero', illustrative: true, mediaType: 'image',
    width: 1600, height: 900, localeUsage: ['ko', 'en', 'ja'], seasonalUsage: ['late-summer'],
    routeUsage: ['/'], sectionUsage: ['home-hero-story-prototype'],
    source: 'Frame derived from a user-provided generated editorial video',
    license: 'User-controlled generated Wakation editorial asset', createdAt: '2026-09-03', verifiedAt: '2026-09-03',
  },
  {
    id: 'home-hero-story-poster-mobile-v2',
    src: '/media/campaigns/home-hero-story-poster-mobile-v2.webp',
    alt: {
      KO: '도심에서 여행 자료와 가방을 챙겨 이동하는 여행자',
      EN: 'A traveler leaving the city with a travel note and bag',
      JP: '街で旅の資料とバッグを手に移動する旅行者',
    ...
    sourceType: 'generated', usage: 'hero', illustrative: true, mediaType: 'image',
    width: 900, height: 1200, localeUsage: ['ko', 'en', 'ja'], seasonalUsage: ['late-summer'],
    routeUsage: ['/'], sectionUsage: ['home-hero-story-prototype-mobile'],
    source: 'Mobile crop derived from a user-provided generated editorial video',
    license: 'User-controlled generated Wakation editorial asset', createdAt: '2026-09-03', verifiedAt: '2026-09-03',
  },
  {
    id: 'home-hero-story-desktop-v2',
    src: '/media/campaigns/home-hero-story-desktop-v2.webm',
    alt: {
      KO: '도심 출발부터 자료 확인, 해안 산책과 바다 앞 작업 공간까지 이어지는 9초 무음 여행 편집 영상',
      EN: 'A nine-second silent story edit from city departure and planning to a coastal walk and workspace',
      JP: '街の出発、旅の確認、海辺の散歩、海を望むワークスペースへ続く9秒の無音編集映像',
    },
    sourceType: 'generated', usage: 'hero', illustrative: true, mediaType: 'video',
    width: 1280, height: 720, localeUsage: ['ko', 'en', 'ja'], seasonalUsage: ['late-summer', 'autumn'],
    routeUsage: ['/'], sectionUsage: ['home-hero-story-prototype'],
    source: 'Superseded nine-second edit; native-frame audit found residual close-up inserts. Retained only for rollback.',
    license: 'User-controlled generated Wakation editorial asset', createdAt: '2026-09-03', verifiedAt: '2026-09-03',
    restriction: {
      KO: '실제 숙소·도시·체험 현장 또는 직접 이용 장면으로 표시하지 않습니다.',
      EN: 'Do not present as a real property, city, experience venue or first-hand stay.',
      JP: '実在の宿泊施設・都市・体験会場、または実体験として表示しません。',
    },
  },
  {
    id: 'home-hero-polish-poster-desktop-v3',
    src: '/media/campaigns/home-hero-polish-poster-desktop-v3.webp',
    alt: {
      KO: '여행 자료와 가방을 챙겨 도심을 나서는 여행자',
      EN: 'A traveler leaving the city with planning notes and a bag',
      JP: '旅の資料とバッグを手に街を出発する旅行者',
    },
    sourceType: 'generated', usage: 'hero', illustrative: true, mediaType: 'image',
    width: 1280, height: 720, localeUsage: ['ko', 'en', 'ja'], seasonalUsage: ['late-summer', 'autumn'],
    routeUsage: ['/', '/en', '/ja'], sectionUsage: ['home-hero-final-polish'],
    source: 'Exact opening frame of the user-provided city-departure video; AVIF/WebP delivery',
    license: 'User-controlled generated Wakation editorial asset', createdAt: '2026-09-04', verifiedAt: '2026-09-04',
  },
  {
    id: 'home-hero-polish-poster-mobile-v3',
    src: '/media/campaigns/home-hero-polish-poster-mobile-v3.webp',
    alt: {
      KO: '도심 출발 장면을 머리 여백과 여행 자료가 보이도록 구성한 세로 포스터',
      EN: 'A city-departure portrait crop preserving headroom and travel notes',
      JP: '頭上の余白と旅の資料を残した街の出発シーンの縦型ポスター',
    },
    sourceType: 'generated', usage: 'hero', illustrative: true, mediaType: 'image',
    width: 900, height: 1200, localeUsage: ['ko', 'en', 'ja'], seasonalUsage: ['late-summer', 'autumn'],
    routeUsage: ['/', '/en', '/ja'], sectionUsage: ['home-hero-final-polish-mobile'],
    source: 'Portrait crop of the user-provided opening frame; static mobile AVIF/WebP only',
    license: 'User-controlled generated Wakation editorial asset', createdAt: '2026-09-04', verifiedAt: '2026-09-04',
  },
  {
    id: 'home-hero-clean-v3',
    src: '/media/campaigns/home-hero-clean-v3.webm',
    alt: {
      KO: '도심 출발, 자료 확인, 해안 도착과 바다 앞 작업 공간을 잇는 10.75초 무음 영상',
      EN: 'A 10.75-second silent edit linking departure, planning, coast and a seaside workspace',
      JP: '出発、旅の確認、海辺への到着、ワークスペースをつなぐ10.75秒の無音映像',
    },
    sourceType: 'generated', usage: 'hero', illustrative: true, mediaType: 'video',
    width: 1280, height: 720, localeUsage: ['ko', 'en', 'ja'], seasonalUsage: ['late-summer', 'autumn'],
    routeUsage: ['/', '/en', '/ja'], sectionUsage: ['home-hero-final-polish'],
    source: 'Native-frame three-source edit; no face close-up; terrace mirrored for right-panel prop visibility; EDL in scripts/hero-final-polish.edl.json',
    license: 'User-controlled generated Wakation editorial asset', createdAt: '2026-09-04', verifiedAt: '2026-09-04',
    restriction: {
      KO: '실제 장소나 직접 이용 증거가 아닌 브랜드 연출 영상입니다. 노트·자료 준비 장면이며 실제 노트북 작업으로 설명하지 않습니다.',
      EN: 'Editorial brand footage, not a real venue or first-hand evidence. Notebook/planning context, not a demonstrated laptop workflow.',
      JP: '実在の施設や実体験の証拠ではないブランド演出映像です。ノートや旅の準備場面で、PC作業の実演ではありません。',
    },
  },
  {
    id: 'home-hero-closeup-v3',
    src: '/media/campaigns/home-hero-closeup-v3.webm',
    alt: {
      KO: '바다 앞 공간에서의 표정을 1.25초 포함한 12초 무음 여행 영상 비교안',
      EN: 'A 12-second comparison edit with one 1.25-second contextual terrace close-up',
      JP: 'テラスでの表情を1.25秒含む12秒の無音旅行映像の比較案',
    },
    sourceType: 'generated', usage: 'hero', illustrative: true, mediaType: 'video',
    width: 1280, height: 720, localeUsage: ['ko', 'en', 'ja'], seasonalUsage: ['late-summer', 'autumn'],
    routeUsage: ['/', '/en', '/ja'], sectionUsage: ['home-hero-final-polish-comparison'],
    source: 'Same native-frame story as CLEAN with one contextual close-up; no sub-second face insert',
    license: 'User-controlled generated Wakation editorial asset', createdAt: '2026-09-04', verifiedAt: '2026-09-04',
    restriction: {
      KO: '실제 숙소·도시·체험 현장 또는 직접 이용 장면으로 표시하지 않습니다.',
      EN: 'Do not present as a real property, city, experience venue or first-hand stay.',
