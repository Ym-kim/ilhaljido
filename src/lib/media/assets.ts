...
const MODEL_DIVERSITY_ASSETS: MediaAsset[] = [
  ...
  {
    // 2026-09-02 운영자 지정 필수 모델. 로스터 WAK-MODEL-*와 별도인 커스텀 정체성으로 관리한다.
    id: 'stay-pilot-custom-airport-model-desktop-v1', src: '/media/brand-models/stay-pilot-custom-airport-model-desktop-v1.webp',
    alt: { KO: '늦여름 교통 허브에서 여행가방의 리본을 정리하며 숙소를 확인하는 성인 여행자', EN: 'An adult traveller checking her stay while tying a ribbon on her suitcase at a late-summer transport hub', JP: '晩夏の交通拠点でスーツケースのリボンを整えながら宿を確認する大人の旅行者' },
    sourceType: 'generated', usage: 'hero', illustrative: true, mediaType: 'image', width: 1600, height: 900, localeUsage: ['ko', 'en', 'ja'], seasonalUsage: ['late-summer', 'autumn'], season: 'late-summer', climateMood: 'warm September daylight in a generalized transport concourse', wardrobeFamily: 'refined early-autumn travel dress', wardrobeTags: ['muted coral sleeveless collared midi dress', 'powder-blue fine knit shoulder layer', 'cream sneakers'], hairDirection: 'long dark hair with natural movement and clean face framing', activityTags: ['tying luggage ribbon', 'checking itinerary', 'departure pause'], travelContext: 'hotel search before a September city departure', styleDirection: 'wide airport-departure editorial with generous left copy space', seasonalFit: 'Korean September late summer to early autumn', activityMood: 'calm anticipatory departure', destinationMood: 'muted coral, powder blue, teal luggage and soft architectural gray', realismLevel: 'high_photoreal', realismTarget: 'high_photoreal_editorial', realismMethod: 'operator-designated identity reference generation with natural hands, full luggage and crop-safe headroom review', photorealReferenceUsed: true, generationProvider: 'openai_builtin_imagegen', auditDisposition: 'KEEP', adjacentModelRestrictions: ['Do not repeat the crouched suitcase-ribbon pose, coral dress, teal luggage or terminal composition on the next major surface'], routeUsage: ['/select/hotel/pilot', '/en/select/hotel/pilot', '/ja/select/hotel/pilot'], sectionUsage: ['stay-search-pilot-hero'], generatedFromReferenceIds: ['operator-mandatory-airport-identity-reference-2026-09-02'], focalPoint: { x: 0.72, y: 0.54 }, safeFraming: { minHeadroomPercent: 14, preserve: ['head', 'face', 'hands', 'bag', 'documents', 'feet'] }, source: 'OpenAI built-in ImageGen using the operator-designated airport identity reference', license: 'User-controlled generated Wakation editorial asset', createdAt: '2026-09-02', verifiedAt: '2026-09-02', restriction: MODEL_DIVERSITY_RESTRICTION,
  },
  {
    id: 'stay-pilot-custom-airport-model-mobile-v1', src: '/media/brand-models/stay-pilot-custom-airport-model-mobile-v1.webp',
    alt: { KO: '늦여름 교통 허브에서 여행가방의 리본을 정리하며 숙소를 확인하는 성인 여행자', EN: 'An adult traveller checking her stay while tying a ribbon on her suitcase at a late-summer transport hub', JP: '晩夏の交通拠点でスーツケースのリボンを整えながら宿を確認する大人の旅行者' },
    sourceType: 'generated', usage: 'hero', illustrative: true, mediaType: 'image', width: 960, height: 1200, localeUsage: ['ko', 'en', 'ja'], seasonalUsage: ['late-summer', 'autumn'], season: 'late-summer', climateMood: 'warm September daylight in a generalized transport concourse', wardrobeFamily: 'refined early-autumn travel dress', wardrobeTags: ['muted coral sleeveless collared midi dress', 'powder-blue fine knit shoulder layer', 'cream sneakers'], hairDirection: 'long dark hair with natural movement and clean face framing', activityTags: ['tying luggage ribbon', 'checking itinerary', 'departure pause'], travelContext: 'hotel search before a September city departure', styleDirection: 'portrait airport-departure editorial with protected headroom and luggage', seasonalFit: 'Korean September late summer to early autumn', activityMood: 'calm anticipatory departure', destinationMood: 'muted coral, powder blue, teal luggage and soft architectural gray', realismLevel: 'high_photoreal', realismTarget: 'high_photoreal_editorial', realismMethod: 'native mobile recomposition from the same operator-designated identity with full head, hands and suitcase', photorealReferenceUsed: true, generationProvider: 'openai_builtin_imagegen', auditDisposition: 'KEEP', adjacentModelRestrictions: ['Do not repeat the crouched suitcase-ribbon pose, coral dress, teal luggage or terminal composition on the next major surface'], routeUsage: ['/select/hotel/pilot', '/en/select/hotel/pilot', '/ja/select/hotel/pilot'], sectionUsage: ['stay-search-pilot-hero-mobile'], generatedFromReferenceIds: ['stay-pilot-custom-airport-model-desktop-v1', 'operator-mandatory-airport-identity-reference-2026-09-02'], focalPoint: { x: 0.57, y: 0.54 }, safeFraming: { minHeadroomPercent: 14, preserve: ['head', 'face', 'hands', 'bag', 'documents', 'feet'] }, source: 'OpenAI built-in ImageGen native mobile recomposition using the operator-designated airport identity reference', license: 'User-controlled generated Wakation editorial asset', createdAt: '2026-09-02', verifiedAt: '2026-09-02', restriction: MODEL_DIVERSITY_RESTRICTION,
  },
  {
