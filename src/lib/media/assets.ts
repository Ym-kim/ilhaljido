...
const MODEL_DIVERSITY_ASSETS: MediaAsset[] = [
  ...
  {
    id: 'tokyo-model-a-vinyl-dress-v1', src: '/media/brand-models/tokyo-model-a-vinyl-dress-v1.webp',
    alt: { KO: '도쿄를 연상시키는 레코드숍에서 남색 원피스를 입고 음반을 고르는 여행자', EN: 'A traveler in an indigo dress choosing a record in a Tokyo-inspired record shop', JP: '東京を思わせるレコードショップで、藍色のワンピースを着てレコードを選ぶ旅人' },
    sourceType: 'generated', usage: 'editorial', illustrative: true, mediaType: 'image', width: 1536, height: 1024, modelId: 'WAK-MODEL-A', localeUsage: ['ko', 'en', 'ja'], seasonalUsage: ['summer', 'late-summer'], season: 'late-summer', climateMood: 'warm Tokyo evening with cool indoor air', wardrobeFamily: 'asymmetrical wrap midi dress', wardrobeTags: ['indigo sleeveless wrap dress', 'vermilion belt', 'silver crossbody bag', 'vermilion slingbacks'], hairDirection: 'loose softly textured hair with natural flyaways', activityTags: ['record browsing', 'overhead reach', 'after-work discovery'], travelContext: 'independent urban culture after work', styleDirection: 'through-rack low diagonal editorial', seasonalFit: 'late-summer Tokyo blue hour', activityMood: 'curious after-work discovery', destinationMood: 'unnamed Tokyo-inspired record shop', realismLevel: 'high_photoreal', realismTarget: 'high_photoreal_editorial', realismMethod: 'identity-anchored generation with full-body anatomy, fabric, hands and crop review', photorealReferenceUsed: true, generationProvider: 'openai_builtin_imagegen', auditDisposition: 'KEEP', adjacentModelRestrictions: ['Do not repeat record browsing, an indigo wrap dress or a through-rack diagonal camera on the next major guide surface'], routeUsage: ['/guide/tokyo', '/en/guide/tokyo', '/ja/guide/tokyo'], sectionUsage: ['guide-lookbook-record-dig'], generatedFromReferenceIds: ['home-hero-model-a-coastal-departure-desktop-v3'], focalPoint: { x: 0.67, y: 0.5 }, safeFraming: { minHeadroomPercent: 14, preserve: ['head', 'face', 'hands', 'bag', 'feet'] }, source: 'OpenAI built-in ImageGen using the approved WAK-MODEL-A production reference', license: 'User-controlled generated Wakation editorial asset', createdAt: '2026-08-11', verifiedAt: '2026-08-11', restriction: MODEL_DIVERSITY_RESTRICTION,
  },
  {
