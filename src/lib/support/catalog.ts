...
export const SUPPORT_PROFILES: SupportProfile[] = [
  ...
  { ...PROFILE_DEFAULTS, id: 'gyeongnam-namhae', category: 'long_stay', duration: 'long', regionGroup: 'gyeongsang', supportTypes: ['accommodation', 'activity'], verifiedAt: '2026-07-26', applicationStart: '2026-07-27', applicationEnd: '2026-08-08', travelStart: '2026-09-01', travelEnd: '2026-10-31', stayNightsMin: 4, stayNightsMax: 29, participantMin: 1, participantMax: 2, snsRequired: true, selectionType: 'review' },
  ...
  { ...PROFILE_DEFAULTS, id: 'gyeongnam-tongyeong', category: 'long_stay', duration: 'long', regionGroup: 'gyeongsang', supportTypes: ['accommodation', 'activity'], verifiedAt: '2026-07-26', stayNightsMin: 6, stayNightsMax: 29, participantMin: 1, participantMax: 2, snsRequired: true, selectionType: 'review' },
