...
export const CAMPAIGN_LANDINGS: Record<CampaignLandingConfig['id'], CampaignLandingConfig> = {
  'japan-short-stay': {
    ...
    heroImage: '/campaign/trip-sets/fukuoka-3n4d-editorial-model-g-v2.webp',
    heroAlt: '창가에서 차를 마시며 쉬는 여행자',
    heroPosition: '48% 48%',
    heroMediaAssetId: 'campaign-model-f-japan-choice-desktop-v2',
    heroMobileMediaAssetId: 'campaign-model-f-japan-choice-mobile-v2',
    ...
    choices: [
      {
        ...
        image: '/campaign/trip-sets/fukuoka-3n4d-editorial-model-g-v2.webp',
        alt: '차분한 창가에서 머무는 후쿠오카 감성의 여행 장면',
        imagePosition: '48% 48%',
        accent: 'coral',
        duration: '3박 4일',
        mood: '차분한 카페 · 온천',
      ...
      },
      {
        ...
        alt: '저녁 골목을 걷는 친구들의 오사카 감성 여행 장면',
        imagePosition: '58% 49%',
        accent: 'ocean',
        duration: '3박 4일',
        mood: '활기찬 거리 · 미식',
