...
const REGIONS = [
  ...
  { id: 'region-korea',     labelKey: 'region_korea',     ids: ['korea-seoul', 'korea-jeju', 'korea-busan', 'korea-jeonju', 'korea-yeosu', 'korea-yangyang', 'korea-gangneung', 'korea-sokcho'], featuredIds: ['stay-playce-jeju', 'stay-fraser-seoul', 'stay-uh-busan', 'stay-skybay-gangneung'] },
...
export function HotelSelectView({ forceLang }: { forceLang?: Lang }) {
  ...
  // forceLang 시 컨텍스트 lang과 무관하게 강제 언어로 번역 (SSG 첫 렌더 일치)
