...
import { getMarketFeatures, getMarketUnits, translate } from '@/lib/i18n'
...
const SELECT_MARKET_PRODUCTS = [
  {
    ...
    img: '/media/destinations/tokyo-editorial-v1.webp',
  },
  {
    id: 'survey-vietnam',
    ...
    img: '/media/destinations/danang-editorial-v1.webp',
  },
  {
    id: 'meetup-us',
    ...
    img: '/media/product-editorial/accommodation-urban-studio-editorial-v1.webp',
  },
]

export function MarketProgramsView({ forceLang }: { forceLang?: Lang }) {
