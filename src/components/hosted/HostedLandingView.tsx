...
const COPY = {
  ...
  report: { KO: '양양 워케이션 운영 기록', EN: 'See the Yangyang field report', JP: '襄陽ワーケーションの運営記録' },
  ...
  proofLead: {
    KO: '2026년 6월 양양에서 워케이션을 운영했고, 참가자 전원이 응답한 설문 결과를 공개했습니다.',
    EN: 'We hosted a Yangyang workation in June 2026 and published the survey completed by every participant.',
    JP: '2026年6月に襄陽でワーケーションを運営し、参加者全員が回答したアンケート結果を公開しました。',
  },
  proofNote: { KO: '양양 참가자 전원 응답 설문 · 2026.6.17–19', EN: 'Yangyang · all-participant survey · Jun 17–19, 2026', JP: '襄陽・参加者全員回答・2026.6.17〜19' },
