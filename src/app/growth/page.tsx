...
const GROWTH_DESKTOP = getMediaAsset('growth-model-f-pottery-learning-desktop-v3')!
const GROWTH_MOBILE = getMediaAsset('growth-model-f-pottery-learning-mobile-v3')!
