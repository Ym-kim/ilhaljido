  ...
  return (
    ...
    <div className="min-h-screen bg-[#FAFAF8]">
      ...
      <section className="relative h-[55vh] flex items-end overflow-hidden dark-surface">
        ...
        <Image src="https://images.unsplash.com/photo-1476514525535-07fb3b4ae5f1?auto=format&fit=crop&w=1800&q=80" alt="" fill priority sizes="100vw" className="object-cover" />
